...
!function (t) {
    ...
    e = function () {
        function e(e, o) {
            ...
            if (a.defaults = {
                    ...
                    transformsEnabled: !1,
                    unslicked: !1
                }, t.extend(a, a.initials), a.activeBreakpoint = null, a.animType = null, a.animProp = null, a.breakpoints = [], a.breakpointSettings = [], a.cssTransitions = !1, a.hidden = "hidden", a.paused = !1, a.positionProp = null, a.respondTo = null, a.rowCount = 1, a.shouldClick = !0, a.$slider = t(e), a.$slidesCache = null, a.transformType = null, a.transitionType = null, a.visibilityChange = "visibilitychange", a.windowWidth = 0, a.windowTimer = null, s = t(e).data("slick") || {}, a.options = t.extend({}, a.defaults, s, o), a.currentSlide = a.options.initialSlide, a.originalSettings = a.options, n = a.options.responsive || null, n && n.length > -1) {
        ...
        })) : (s.applyTransition(), e = Math.ceil(e), o[s.animType] = s.options.vertical === !1 ? "translate3d(" + e + "px, 0px, 0px)" : "translate3d(0px," + e + "px, 0px)", s.$slideTrack.css(o), i && setTimeout(function () {
        ...
        var i, o, s, n = this, r = !1, a = n.$slider.width(), l = window.innerWidth || t(window).width();
        if ("window" === n.respondTo ? s = l : "slider" === n.respondTo ? s = a : "min" === n.respondTo && (s = Math.min(l, a)), n.originalSettings.responsive && n.originalSettings.responsive.length > -1 && null !== n.originalSettings.responsive) {
            ...
            null !== o ? null !== n.activeBreakpoint ? o !== n.activeBreakpoint && (n.activeBreakpoint = o, "unslick" === n.breakpointSettings[o] ? n.unslick(o) : (n.options = t.extend({}, n.originalSettings, n.breakpointSettings[o]), e === !0 && (n.currentSlide = n.options.initialSlide), n.refresh(e)), r = o) : (n.activeBreakpoint = o, "unslick" === n.breakpointSettings[o] ? n.unslick(o) : (n.options = t.extend({}, n.originalSettings, n.breakpointSettings[o]), e === !0 && (n.currentSlide = n.options.initialSlide), n.refresh(e)), r = o) : null !== n.activeBreakpoint && (n.activeBreakpoint = null, n.options = n.originalSettings, e === !0 && (n.currentSlide = n.options.initialSlide), n.refresh(e), r = o), e || r === !1 || n.$slider.trigger("breakpoint", [n, r])
        }
    }, e.prototype.changeSlide = function (e, i) {
        var o, s, n, r = this, a = t(e.target);
        switch (a.is("a") && e.preventDefault(), a.is("li") || (a = a.closest("li")), n = 0 !== r.slideCount % r.options.slidesToScroll, o = n ? 0 : (r.slideCount - r.currentSlide) % r.options.slidesToScroll, e.data.message) {
            case"previous":
        ...
        var e, i, o = this;
        if (e = o.getNavigableIndexes(), i = 0, t > e[e.length - 1])t = e[e.length - 1]; else for (var s in e) {
            if (t < e[s]) {
                t = i;
                break
            }
        ...
        if (t.options.infinite === !0)for (; e < t.slideCount;)++o, e = i + t.options.slidesToShow, i += t.options.slidesToScroll <= t.options.slidesToShow ? t.options.slidesToScroll : t.options.slidesToShow; else if (t.options.centerMode === !0)o = t.slideCount; else for (; e < t.slideCount;)++o, e = i + t.options.slidesToShow, i += t.options.slidesToScroll <= t.options.slidesToShow ? t.options.slidesToScroll : t.options.slidesToShow;
        return o - 1
    }, e.prototype.getLeft = function (t) {
        var e, i, o, s = this, n = 0;
        return s.slideOffset = 0, i = s.$slides.first().outerHeight(), s.options.infinite === !0 ? (s.slideCount > s.options.slidesToShow && (s.slideOffset = -1 * s.slideWidth * s.options.slidesToShow, n = -1 * i * s.options.slidesToShow), 0 !== s.slideCount % s.options.slidesToScroll && t + s.options.slidesToScroll > s.slideCount && s.slideCount > s.options.slidesToShow && (t > s.slideCount ? (s.slideOffset = -1 * (s.options.slidesToShow - (t - s.slideCount)) * s.slideWidth, n = -1 * (s.options.slidesToShow - (t - s.slideCount)) * i) : (s.slideOffset = -1 * s.slideCount % s.options.slidesToScroll * s.slideWidth, n = -1 * s.slideCount % s.options.slidesToScroll * i))) : t + s.options.slidesToShow > s.slideCount && (s.slideOffset = (t + s.options.slidesToShow - s.slideCount) * s.slideWidth, n = (t + s.options.slidesToShow - s.slideCount) * i), s.slideCount <= s.options.slidesToShow && (s.slideOffset = 0, n = 0), s.options.centerMode === !0 && s.options.infinite === !0 ? s.slideOffset += s.slideWidth * Math.floor(s.options.slidesToShow / 2) - s.slideWidth : s.options.centerMode === !0 && (s.slideOffset = 0, s.slideOffset += s.slideWidth * Math.floor(s.options.slidesToShow / 2)), e = s.options.vertical === !1 ? -1 * t * s.slideWidth + s.slideOffset : -1 * t * i + n, s.options.variableWidth === !0 && (o = s.$slideTrack.children(".slick-slide").eq(s.slideCount <= s.options.slidesToShow || s.options.infinite === !1 ? t : t + s.options.slidesToShow), e = o[0] ? -1 * o[0].offsetLeft : 0, s.options.centerMode === !0 && (o = s.$slideTrack.children(".slick-slide").eq(s.options.infinite === !1 ? t : t + s.options.slidesToShow + 1), e = o[0] ? -1 * o[0].offsetLeft : 0, e += (s.$list.width() - o.outerWidth()) / 2)), e
        ...
        function e(e) {
            t("img[data-lazy]", e).each(function () {
                ...
                }, o.src = i, e.css({opacity: 0}).attr("src", i).removeAttr("data-lazy").removeClass("slick-loading")
            })
        }
        ...
        i.destroy(!0), t.extend(i, i.initials), i.init(), e || i.changeSlide({data: {message: "index", index: o}}, !1)
        ...
        var e, i, o, s, n = this;
        n.$slider.find(".slick-slide").removeClass("slick-active").attr("aria-hidden", "true").removeClass("slick-center"), i = n.$slider.find(".slick-slide"), n.options.centerMode === !0 ? (e = Math.floor(n.options.slidesToShow / 2), n.options.infinite === !0 && (t >= e && t <= n.slideCount - 1 - e ? n.$slides.slice(t - e, t + e + 1).addClass("slick-active").attr("aria-hidden", "false") : (o = n.options.slidesToShow + t, i.slice(o - e + 1, o + e + 2).addClass("slick-active").attr("aria-hidden", "false")), 0 === t ? i.eq(i.length - 1 - n.options.slidesToShow).addClass("slick-center") : t === n.slideCount - 1 && i.eq(n.options.slidesToShow).addClass("slick-center")), n.$slides.eq(t).addClass("slick-center")) : t >= 0 && t <= n.slideCount - n.options.slidesToShow ? n.$slides.slice(t, t + n.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false") : i.length <= n.options.slidesToShow ? i.addClass("slick-active").attr("aria-hidden", "false") : (s = n.slideCount % n.options.slidesToShow, o = n.options.infinite === !0 ? n.options.slidesToShow + t : t, n.options.slidesToShow == n.options.slidesToScroll && n.slideCount - t < n.options.slidesToShow ? i.slice(o - (n.options.slidesToShow - s), o + s).addClass("slick-active").attr("aria-hidden", "false") : i.slice(o, o + n.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false")), "ondemand" === n.options.lazyLoad && n.lazyLoad()
        ...
        var t, i = this, o = arguments[0], s = Array.prototype.slice.call(arguments, 1), n = i.length, r = 0;
        for (r; n > r; r++)if ("object" == typeof o || "undefined" == typeof o ? i[r].slick = new e(i[r], o) : t = i[r].slick[o].apply(i[r].slick, s), "undefined" != typeof t)return t;
        return i
    }
}), !function (t) {
    t.flexslider = function (e, i) {
        ...
        t.data(e, "flexslider", o), m = {
            init: function () {
                ...
                }), o.vars.pauseInvisible && m.pauseInvisible.isHidden() || (o.vars.initDelay > 0 ? o.startTimeout = setTimeout(o.play, o.vars.initDelay) : o.play())), h && m.asNav.setup(), a && o.vars.touch && m.touch(), (!f || f && o.vars.smoothHeight) && t(window).bind("resize orientationchange focus", m.resize), o.find("img").attr("draggable", "false"), setTimeout(function () {
                    o.vars.start(o)
                }, 200)
            }, asNav: {
                setup: function () {
                    o.asNav = !0, o.animatingTo = Math.floor(o.currentSlide / o.move), o.currentItem = o.currentSlide, o.slides.removeClass(n + "active-slide").eq(o.currentItem).addClass(n + "active-slide"), r ? (e._slider = o, o.slides.each(function () {
                        var e = this;
                        e._gesture = new MSGesture, e._gesture.target = e, e.addEventListener("MSPointerDown", function (t) {
                            t.preventDefault(), t.currentTarget._gesture && t.currentTarget._gesture.addPointer(t.pointerId)
                        }, !1), e.addEventListener("MSGestureTap", function (e) {
                            e.preventDefault();
                            var i = t(this), s = i.index();
                            t(o.vars.asNavFor).data("flexslider").animating || i.hasClass("active") || (o.direction = o.currentItem < s ? "next" : "prev", o.flexAnimate(s, o.vars.pauseOnAction, !1, !0, !0))
                        })
                    })) : o.slides.on(l, function (e) {
                        e.preventDefault();
                        var i = t(this), s = i.index(), r = i.offset().left - t(o).scrollLeft();
                        0 >= r && i.hasClass(n + "active-slide") ? o.flexAnimate(o.getTarget("prev"), !0) : t(o.vars.asNavFor).data("flexslider").animating || i.hasClass(n + "active-slide") || (o.direction = o.currentItem < s ? "next" : "prev", o.flexAnimate(s, o.vars.pauseOnAction, !1, !0, !0))
                    })
                }
            }, controlNav: {
                setup: function () {
                    ...
                    var e, i, s = "thumbnails" === o.vars.controlNav ? "control-thumbs" : "control-paging", r = 1;
                    if (o.controlNavScaffold = t('<ol class="' + n + "control-nav " + n + s + '"></ol>'), o.pagingCount > 1)for (var a = 0; a < o.pagingCount; a++) {
                        if (i = o.slides.eq(a), e = "thumbnails" === o.vars.controlNav ? '<img src="' + i.attr("data-thumb") + '"/>' : "<a>" + r + "</a>", "thumbnails" === o.vars.controlNav && !0 === o.vars.thumbCaptions) {
                            ...
                            "" !== d && void 0 !== d && (e += '<span class="' + n + 'caption">' + d + "</span>")
                        }
                    ...
                    o.controlsContainer ? t(o.controlsContainer).append(o.controlNavScaffold) : o.append(o.controlNavScaffold), m.controlNav.set(), m.controlNav.active(), o.controlNavScaffold.delegate("a, img", l, function (e) {
                        if (e.preventDefault(), "" === c || c === e.type) {
                            var i = t(this), s = o.controlNav.index(i);
                            i.hasClass(n + "active") || (o.direction = s > o.currentSlide ? "next" : "prev", o.flexAnimate(s, o.vars.pauseOnAction))
                        }
                    ...
                    o.controlNav = t("." + n + "control-nav li " + e, o.controlsContainer ? o.controlsContainer : o)
                }, active: function () {
                    o.controlNav.removeClass(n + "active").eq(o.animatingTo).addClass(n + "active")
                }, update: function (e, i) {
                ...
                setup: function () {
                    var e = t('<ul class="' + n + 'direction-nav"><li class="' + n + 'nav-prev"><a class="' + n + 'prev" href="#">' + o.vars.prevText + '</a></li><li class="' + n + 'nav-next"><a class="' + n + 'next" href="#">' + o.vars.nextText + "</a></li></ul>");
                    o.customDirectionNav ? o.directionNav = o.customDirectionNav : o.controlsContainer ? (t(o.controlsContainer).append(e), o.directionNav = t("." + n + "direction-nav li a", o.controlsContainer)) : (o.append(e), o.directionNav = t("." + n + "direction-nav li a", o)), m.directionNav.update(), o.directionNav.bind(l, function (e) {
                        e.preventDefault();
                        var i;
                        ("" === c || c === e.type) && (i = o.getTarget(t(this).hasClass(n + "next") ? "next" : "prev"), o.flexAnimate(i, o.vars.pauseOnAction)), "" === c && (c = e.type), m.setToClearWatchedEvent()
                    })
                }, update: function () {
                    var t = n + "disabled";
                ...
                setup: function () {
                    var e = t('<div class="' + n + 'pauseplay"><a></a></div>');
                    o.controlsContainer ? (o.controlsContainer.append(e), o.pausePlay = t("." + n + "pauseplay a", o.controlsContainer)) : (o.append(e), o.pausePlay = t("." + n + "pauseplay a", o)), m.pausePlay.update(o.vars.slideshow ? n + "pause" : n + "play"), o.pausePlay.bind(l, function (e) {
                        e.preventDefault(), ("" === c || c === e.type) && (t(this).hasClass(n + "pause") ? (o.manualPause = !0, o.manualPlay = !1, o.pause()) : (o.manualPause = !1, o.manualPlay = !0, o.play())), "" === c && (c = e.type), m.setToClearWatchedEvent()
                    })
                }, update: function (t) {
                    "play" === t ? o.pausePlay.removeClass(n + "pause").addClass(n + "play").html(o.vars.playText) : o.pausePlay.removeClass(n + "play").addClass(n + "pause").html(o.vars.pauseText)
                }
            }, touch: function () {
                function t(t) {
                    t.stopPropagation(), o.animating ? t.preventDefault() : (o.pause(), e._gesture.addPointer(t.pointerId), _ = 0, c = d ? o.h : o.w, m = Number(new Date), l = p && u && o.animatingTo === o.last ? 0 : p && u ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : p && o.currentSlide === o.last ? o.limit : p ? (o.itemW + o.vars.itemMargin) * o.move * o.currentSlide : u ? (o.last - o.currentSlide + o.cloneOffset) * c : (o.currentSlide + o.cloneOffset) * c)
                }
                ...
                function i(t) {
                    ...
                    if (i) {
                        var o = -t.translationX, s = -t.translationY;
                        return _ += d ? s : o, h = _, b = d ? Math.abs(_) < Math.abs(-o) : Math.abs(_) < Math.abs(-s), t.detail === t.MSGESTURE_FLAG_INERTIA ? void setImmediate(function () {
                            e._gesture.stop()
                        }) : void((!b || Number(new Date) - m > 500) && (t.preventDefault(), !f && i.transitions && (i.vars.animationLoop || (h = _ / (0 === i.currentSlide && 0 > _ || i.currentSlide === i.last && _ > 0 ? Math.abs(_) / c + 2 : 1)), i.setProps(l + h, "setTouch"))))
                    }
                }
                ...
                function s(t) {
                    ...
                    if (e) {
                        if (e.animatingTo === e.currentSlide && !b && null !== h) {
                            var i = u ? -h : h, o = e.getTarget(i > 0 ? "next" : "prev");
                            e.canAdvance(o) && (Number(new Date) - m < 550 && Math.abs(i) > 50 || Math.abs(i) > c / 2) ? e.flexAnimate(o, e.vars.pauseOnAction) : f || e.flexAnimate(e.currentSlide, e.vars.pauseOnAction, !0)
                        }
                        n = null, a = null, h = null, l = null, _ = 0
                    }
                }

                var n, a, l, c, h, m, g, v, y, b = !1, w = 0, T = 0, _ = 0;
                r ? (e.style.msTouchAction = "none", e._gesture = new MSGesture, e._gesture.target = e, e.addEventListener("MSPointerDown", t, !1), e._slider = o, e.addEventListener("MSGestureChange", i, !1), e.addEventListener("MSGestureEnd", s, !1)) : (g = function (t) {
                    o.animating ? t.preventDefault() : (window.navigator.msPointerEnabled || 1 === t.touches.length) && (o.pause(), c = d ? o.h : o.w, m = Number(new Date), w = t.touches[0].pageX, T = t.touches[0].pageY, l = p && u && o.animatingTo === o.last ? 0 : p && u ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : p && o.currentSlide === o.last ? o.limit : p ? (o.itemW + o.vars.itemMargin) * o.move * o.currentSlide : u ? (o.last - o.currentSlide + o.cloneOffset) * c : (o.currentSlide + o.cloneOffset) * c, n = d ? T : w, a = d ? w : T, e.addEventListener("touchmove", v, !1), e.addEventListener("touchend", y, !1))
                }, v = function (t) {
                    w = t.touches[0].pageX, T = t.touches[0].pageY, h = d ? n - T : n - w, b = d ? Math.abs(h) < Math.abs(w - a) : Math.abs(h) < Math.abs(T - a);
                    var e = 500;
                    ...
                    if (e.removeEventListener("touchmove", v, !1), o.animatingTo === o.currentSlide && !b && null !== h) {
                        var t = u ? -h : h, i = o.getTarget(t > 0 ? "next" : "prev");
                        o.canAdvance(i) && (Number(new Date) - m < 550 && Math.abs(t) > 50 || Math.abs(t) > c / 2) ? o.flexAnimate(i, o.vars.pauseOnAction) : f || o.flexAnimate(o.currentSlide, o.vars.pauseOnAction, !0)
                    }
                    e.removeEventListener("touchend", y, !1), n = null, a = null, h = null, l = null
                ...
                var i = t(o.vars.sync).data("flexslider"), s = o.animatingTo;
                switch (e) {
                    case"animate":
                        i.flexAnimate(s, o.vars.pauseOnAction, !1, !0);
                        break;
                    case"play":
        ...
        }, o.flexAnimate = function (e, i, s, r, l) {
            if (o.vars.animationLoop || e === o.currentSlide || (o.direction = e > o.currentSlide ? "next" : "prev"), h && 1 === o.pagingCount && (o.direction = o.currentItem < e ? "next" : "prev"), !o.animating && (o.canAdvance(e, l) || s) && o.is(":visible")) {
                if (h && r) {
                    var c = t(o.vars.asNavFor).data("flexslider");
                    if (o.atEnd = 0 === e || e === o.count - 1, c.flexAnimate(e, !0, !1, !0, l), o.direction = o.currentItem < e ? "next" : "prev", c.direction = o.direction, Math.ceil((e + 1) / o.visible) - 1 === o.currentSlide || 0 === e)return o.currentItem = e, o.slides.removeClass(n + "active-slide").eq(e).addClass(n + "active-slide"), !1;
                    o.currentItem = e, o.slides.removeClass(n + "active-slide").eq(e).addClass(n + "active-slide"), e = Math.floor(e / o.visible)
                }
                if (o.animating = !0, o.animatingTo = e, i && o.pause(), o.vars.before(o), o.syncExists && !l && m.sync("animate"), o.vars.controlNav && m.controlNav.active(), p || o.slides.removeClass(n + "active-slide").eq(e).addClass(n + "active-slide"), o.atEnd = 0 === e || e === o.last, o.vars.directionNav && m.directionNav.update(), e === o.last && (o.vars.end(o), o.vars.animationLoop || o.pause()), f)a ? (o.slides.eq(o.currentSlide).css({
                    opacity: 0,
                    zIndex: 1
                }), o.slides.eq(e).css({
                    opacity: 1,
                    ...
                    var g, v, y, b = d ? o.slides.filter(":first").height() : o.computedW;
            ...
            var i = h ? o.pagingCount - 1 : o.last;
            return e ? !0 : h && o.currentItem === o.count - 1 && 0 === t && "prev" === o.direction ? !0 : h && 0 === o.currentItem && t === o.pagingCount - 1 && "next" !== o.direction ? !1 : t !== o.currentSlide || h ? o.vars.animationLoop ? !0 : o.atEnd && 0 === o.currentSlide && t === i && "next" !== o.direction ? !1 : o.atEnd && o.currentSlide === i && 0 === t && "next" === o.direction ? !1 : !0 : !1
            ...
            var s = function () {
                var i = t ? t : (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo, s = function () {
                    if (p)return "setTouch" === e ? t : u && o.animatingTo === o.last ? 0 : u ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : o.animatingTo === o.last ? o.limit : i;
                    switch (e) {
                        case"setTotal":
            ...
            o.transitions && (s = d ? "translate3d(0," + s + ",0)" : "translate3d(" + s + ",0,0)", i = void 0 !== i ? i / 1e3 + "s" : "0s", o.container.css("-" + o.pfx + "-transition-duration", i), o.container.css("transition-duration", i)), o.args[o.prop] = s, (o.transitions || void 0 === i) && o.container.css(o.args), o.container.css("transform", s)
        }, o.setup = function (e) {
            if (f)o.slides.css({
                width: "100%",
                "float": "left",
                ...
                display: "block",
                zIndex: 1
            }).eq(o.currentSlide).css({zIndex: 2}).animate({opacity: 1}, o.vars.animationSpeed, o.vars.easing)), o.vars.smoothHeight && m.smoothHeight(); else {
                var i, s;
                "init" === e && (o.viewport = t('<div class="' + n + 'viewport"></div>').css({
                    overflow: "hidden",
                    position: "relative"
                }).appendTo(o).append(o.container), o.cloneCount = 0, o.cloneOffset = 0, u && (s = t.makeArray(o.slides).reverse(), o.slides = t(s), o.container.empty().append(o.slides))), o.vars.animationLoop && !p && (o.cloneCount = 2, o.cloneOffset = 1, "init" !== e && o.container.find(".clone").remove(), o.container.append(m.uniqueID(o.slides.first().clone().addClass("clone")).attr("aria-hidden", "true")).prepend(m.uniqueID(o.slides.last().clone().addClass("clone")).attr("aria-hidden", "true"))), o.newSlides = t(o.vars.selector, o), i = u ? o.count - 1 - o.currentSlide + o.cloneOffset : o.currentSlide + o.cloneOffset, d && !p ? (o.container.height(200 * (o.count + o.cloneCount) + "%").css("position", "absolute").width("100%"), setTimeout(function () {
            ...
            p || o.slides.removeClass(n + "active-slide").eq(o.currentSlide).addClass(n + "active-slide"), o.vars.init(o)
        }, o.doMath = function () {
            var t = o.slides.first(), e = o.vars.itemMargin, i = o.vars.minItems, s = o.vars.maxItems;
            o.w = void 0 === o.viewport ? o.width() : o.viewport.width(), o.h = t.height(), o.boxPadding = t.outerWidth() - t.width(), p ? (o.itemT = o.vars.itemWidth + e, o.minW = i ? i * o.itemT : o.w, o.maxW = s ? s * o.itemT - e : o.w, o.itemW = o.minW > o.w ? (o.w - e * (i - 1)) / i : o.maxW < o.w ? (o.w - e * (s - 1)) / s : o.vars.itemWidth > o.w ? o.w : o.vars.itemWidth, o.visible = Math.floor(o.w / o.itemW), o.move = o.vars.move > 0 && o.vars.move < o.visible ? o.vars.move : o.visible, o.pagingCount = Math.ceil((o.count - o.visible) / o.move + 1), o.last = o.pagingCount - 1, o.limit = 1 === o.pagingCount ? 0 : o.vars.itemWidth > o.w ? o.itemW * (o.count - 1) + e * (o.count - 1) : (o.itemW + e) * o.count - o.w - e) : (o.itemW = o.w, o.pagingCount = o.count, o.last = o.count - 1), o.computedW = o.itemW - o.boxPadding
            ...
            var s = t(e);
            o.count += 1, o.last = o.count - 1, d && u ? void 0 !== i ? o.slides.eq(o.count - i).after(s) : o.container.prepend(s) : void 0 !== i ? o.slides.eq(i).before(s) : o.container.append(s), o.update(i, "add"), o.slides = t(o.vars.selector + ":not(.clone)", o), o.setup(), o.vars.added(o)
        }, o.removeSlide = function (e) {
            var i = isNaN(e) ? o.slides.index(t(e)) : e;
            o.count -= 1, o.last = o.count - 1, isNaN(e) ? t(e, o.slides).remove() : d && u ? o.slides.eq(o.last).remove() : o.slides.eq(e).remove(), o.doMath(), o.update(i, "remove"), o.slides = t(o.vars.selector + ":not(.clone)", o), o.setup(), o.vars.removed(o)
        }, m.init()
        ...
        if (void 0 === e && (e = {}), "object" == typeof e)return this.each(function () {
            var i = t(this), o = e.selector ? e.selector : ".slides > li", s = i.find(o);
    ...
    t.fn.fitVids = function (e) {
        ...
        if (!document.getElementById("fit-vids-style")) {
            var o = document.head || document.getElementsByTagName("head")[0], s = ".fluid-width-video-wrapper{width:100%;position:relative;padding:0;}.fluid-width-video-wrapper iframe,.fluid-width-video-wrapper object,.fluid-width-video-wrapper embed {position:absolute;top:0;left:0;width:100%;height:100%;}", n = document.createElement("div");
        ...
        return e && t.extend(i, e), this.each(function () {
            ...
            s = s.not("object object"), s = s.not(o), s.each(function () {
                ...
                if (!(e.parents(o).length > 0 || "embed" === this.tagName.toLowerCase() && e.parent("object").length || e.parent(".fluid-width-video-wrapper").length)) {
                    ...
                    var i = "object" === this.tagName.toLowerCase() || e.attr("height") && !isNaN(parseInt(e.attr("height"), 10)) ? parseInt(e.attr("height"), 10) : e.height(), s = isNaN(parseInt(e.attr("width"), 10)) ? e.width() : parseInt(e.attr("width"), 10), n = i / s;
                    if (!e.attr("name")) {
            ...
            t.fn[e] = function (s) {
                if ("string" == typeof s) {
                    for (var r = o.call(arguments, 1), a = 0, l = this.length; l > a; a++) {
                        ...
                        if (d)if (t.isFunction(d[s]) && "_" !== s.charAt(0)) {
                            var u = d[s].apply(d, r);
                            if (void 0 !== u)return u
                        } else n("no such method '" + s + "' for " + e + " instance"); else n("cannot call methods on " + e + " prior to initialization; attempted to call '" + s + "'")
                    }
                    return this
                }
                return this.each(function () {
                    var o = t.data(this, e);
                    o ? (o.option(s), o._init()) : (o = new i(this, s), t.data(this, e, o))
                })
            }
        }
    ...
    "function" == typeof define && define.amd ? define("eventie/eventie", n) : "object" == typeof exports ? module.exports = n : t.eventie = n
}(window), function () {
    function t() {
    }
    ...
    var o = t.prototype, s = this, n = s.EventEmitter;
    o.getListeners = function (t) {
        ...
        var o, s = this.getListenersAsObject(t), n = "object" == typeof i;
        for (o in s)s.hasOwnProperty(o) && -1 === e(s[o], i) && s[o].push(n ? i : {listener: i, once: !1});
        return this
        ...
        var o, s, n = this.getListenersAsObject(t);
        ...
        var i, o, s, n, r = this.getListenersAsObject(t);
        for (s in r)if (r.hasOwnProperty(s))for (o = r[s].length; o--;)i = r[s][o], i.once === !0 && this.removeListener(t, i.listener),
            n = i.listener.apply(this, e || []), n === this._getOnceReturnValue() && this.removeListener(t, i.listener);
        return this
    ...
    function e(t) {
        if (t) {
            ...
            for (var e, s = 0, n = i.length; n > s; s++)if (e = i[s] + t, "string" == typeof o[e])return e
        }
    }
    ...
    function s(i) {
        function s() {
            if (!p) {
                ...
                if (c = function () {
                    ...
                    r.appendChild(s);
                    var a = c(s);
                    u = 200 === e(a.width), r.removeChild(s)
                }
            }
        }
        ...
        function a(t) {
            if (s(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                for (var a = n.isBorderBox = !(!d || !i[d] || "border-box" !== i[d]), p = 0, f = r.length; f > p; p++) {
                    var h = r[p], m = i[h];
                    m = l(t, m);
                    var g = parseFloat(m);
                    n[h] = isNaN(g) ? 0 : g
                }
                var v = n.paddingLeft + n.paddingRight, y = n.paddingTop + n.paddingBottom, b = n.marginLeft + n.marginRight, w = n.marginTop + n.marginBottom, T = n.borderLeftWidth + n.borderRightWidth, _ = n.borderTopWidth + n.borderBottomWidth, S = a && u, P = e(i.width);
                P !== !1 && (n.width = P + (S ? 0 : v + T));
                var C = e(i.height);
                return C !== !1 && (n.height = C + (S ? 0 : y + _)), n.innerWidth = n.width - (v + T), n.innerHeight = n.height - (y + _), n.outerWidth = n.width + b, n.outerHeight = n.height + w, n
            }
        }

        function l(e, i) {
            if (t.getComputedStyle || -1 === i.indexOf("%"))return i;
            var o = e.style, s = o.left, n = e.runtimeStyle, r = n && n.left;
            return r && (n.left = e.currentStyle.left), o.left = i, i = o.pixelLeft, o.left = s, r && (n.left = r), i
        }
    ...
    function s(s) {
        return "complete" === n.readyState ? o() : (s.bind(n, "DOMContentLoaded", i), s.bind(n, "readystatechange", i), s.bind(t, "load", i)), e
    }
    ...
    function o(t, e) {
        i(t);
        for (var o = t.parentNode.querySelectorAll(e), s = 0, n = o.length; n > s; s++)if (o[s] === t)return !0;
        return !1
    }
    ...
    o.isArray = function (t) {
        ...
        var e = [];
        if (o.isArray(t))e = t; else if (t && "number" == typeof t.length)for (var i = 0, s = t.length; s > i; i++)e.push(t[i]); else e.push(t);
        return e
        ...
        t = o.makeArray(t);
        for (var s = [], n = 0, r = t.length; r > n; n++) {
            var a = t[n];
            if (o.isElement(a))if (e) {
                i(a, e) && s.push(a);
                for (var l = a.querySelectorAll(e), c = 0, d = l.length; d > c; c++)s.push(l[c])
            } else s.push(a)
        }
        return s
    ...
    var n = t.console;
    return o.htmlInit = function (i, s) {
        e(function () {
            for (var e = o.toDashed(s), r = document.querySelectorAll(".js-" + e), a = "data-" + e + "-options", l = 0, c = r.length; c > l; l++) {
                var d, u = r[l], p = u.getAttribute(a);
                try {
                    d = p && JSON.parse(p)
                } catch (f) {
                    n && n.error("Error parsing " + a + " on " + u.nodeName.toLowerCase() + (u.id ? "#" + u.id : "") + ": " + f);
                    continue
                }
                var h = new i(u, d), m = t.jQuery;
                m && m.data(u, s, h)
            }
        })
    }, o
}), function (t, e) {
    "function" == typeof define && define.amd ? define("outlayer/item", ["eventEmitter/EventEmitter", "get-size/get-size", "get-style-property/get-style-property", "fizzy-ui-utils/utils"], function (i, o, s, n) {
        return e(t, i, o, s, n)
    ...
    var a = t.getComputedStyle, l = a ? function (t) {
        return a(t, null)
    } : function (t) {
        return t.currentStyle
    }, c = o("transition"), d = o("transform"), u = c && d, p = !!o("perspective"), f = {
        WebkitTransition: "webkitTransitionEnd",
        MozTransition: "transitionend",
        OTransition: "otransitionend",
        transition: "transitionend"
    }[c], h = ["transform", "transition", "transitionDuration", "transitionProperty"], m = function () {
    ...
    s.extend(r.prototype, e.prototype), r.prototype._create = function () {
        ...
        var t = l(this.element), e = this.layout.options, i = e.isOriginLeft, o = e.isOriginTop, s = parseInt(t[i ? "left" : "right"], 10), n = parseInt(t[o ? "top" : "bottom"], 10);
        s = isNaN(s) ? 0 : s, n = isNaN(n) ? 0 : n;
        var r = this.layout.size;
        s -= i ? r.paddingLeft : r.paddingRight, n -= o ? r.paddingTop : r.paddingBottom, this.position.x = s, this.position.y = n
        ...
        r = e.percentPosition && !e.isHorizontal ? 100 * (r / t.width) + "%" : r + "px", i[s] = r, i[n] = "";
        var a = e.isOriginTop ? "paddingTop" : "paddingBottom", l = e.isOriginTop ? "top" : "bottom", c = e.isOriginTop ? "bottom" : "top", d = this.position.y + t[a];
        d = e.percentPosition && e.isHorizontal ? 100 * (d / t.height) + "%" : d + "px", i[l] = d, i[c] = "", this.css(i), this.emitEvent("layout", [this])
    };
    ...
    r.prototype._transitionTo = function (t, e) {
        ...
        var a = t - i, l = e - o, c = {}, d = this.layout.options;
        a = d.isOriginLeft ? a : -a, l = d.isOriginTop ? l : -l, c.transform = g(a, l), this.transition({
            to: c,
    ...
    "function" == typeof define && define.amd ? define("outlayer/outlayer", ["eventie/eventie", "eventEmitter/EventEmitter", "get-size/get-size", "fizzy-ui-utils/utils", "./item"], function (i, o, s, n, r) {
        return e(t, i, o, s, n, r)
    ...
    return r.namespace = "outlayer", r.Item = n, r.defaults = {
        ...
        for (var e = this._filterFindItemElements(t), i = this.constructor.Item, o = [], s = 0, n = e.length; n > s; s++) {
            var r = e[s], a = new i(r, this);
            o.push(a)
        }
        return o
        ...
        n ? ("string" == typeof n ? i = this.element.querySelector(n) : s.isElement(n) && (i = n), this[t] = i ? o(i)[e] : n) : this[t] = 0
        ...
        var e = t.getBoundingClientRect(), i = this._boundingRect, s = o(t), n = {
        ...
        delete u[s], delete this.element.outlayerGUID, l && l.removeData(this.element, this.constructor.namespace)
    }, r.data = function (t) {
        ...
        }, i.Item.prototype = new n, s.htmlInit(i, t), l && l.bridget && l.bridget(t, i), i
    }, r.Item = n, r
}), function (t, e) {
    ...
    return o.prototype._resetLayout = function () {
        ...
        var o = this.columnWidth += this.gutter, s = this.containerWidth + this.gutter, n = s / o, r = o - s % o, a = r && 1 > r ? "round" : "floor";
        ...
        t.getSize();
        var e = t.size.outerWidth % this.columnWidth, o = e && 1 > e ? "round" : "ceil", s = Math[o](t.size.outerWidth / this.columnWidth);
        s = Math.min(s, this.cols);
        for (var n = this._getColGroup(s), r = Math.min.apply(Math, n), a = i.indexOf(n, r), l = {
            x: this.columnWidth * a,
            y: r
        }, c = r + t.size.outerHeight, d = this.cols + 1 - n.length, u = 0; d > u; u++)this.colYs[a + u] = c;
        return l
        ...
        var i = e(t), o = this._getElementOffset(t), s = this.options.isOriginLeft ? o.left : o.right, n = s + i.outerWidth, r = Math.floor(s / this.columnWidth);
        r = Math.max(0, r);
    ...
    var o = t.create("masonry"), s = o.prototype._getElementOffset, n = o.prototype.layout, r = o.prototype._getMeasurement;
    i(o.prototype, e.prototype), o.prototype._getElementOffset = s, o.prototype.layout = n, o.prototype._getMeasurement = r;
    ...
    "function" == typeof define && define.amd ? define(["outlayer/outlayer", "get-size/get-size", "matches-selector/matches-selector", "fizzy-ui-utils/utils", "isotope/js/item", "isotope/js/layout-mode", "isotope/js/layout-modes/masonry", "isotope/js/layout-modes/fit-rows", "isotope/js/layout-modes/vertical"], function (i, o, s, n, r, a) {
    ...
    function a(t, e) {
        return function (i, o) {
            for (var s = 0, n = t.length; n > s; s++) {
                var r = t[s], a = i.sortData[r], l = o.sortData[r];
                if (a > l || l > a) {
                    var c = void 0 !== e[r] ? e[r] : e, d = c ? 1 : -1;
                    return (a > l ? 1 : -1) * d
                }
            }
            return 0
    ...
    }, d = document.documentElement, u = d.textContent ? function (t) {
        return t.textContent
    } : function (t) {
        return t.innerText
    }, p = e.create("isotope", {layoutMode: "masonry", isJQueryFiltering: !0, sortAscending: !0});
    p.Item = n, p.LayoutMode = r, p.prototype._create = function () {
        ...
        function t() {
            e && i && o && s.emitEvent("arrangeComplete", [s.filteredItems]);
        }
        ...
        e = e || "*";
        for (var i = [], o = [], s = [], n = this._getFilterTest(e), r = 0, a = t.length; a > r; r++) {
            var l = t[r];
            if (!l.isIgnored) {
                var c = n(l);
                c && i.push(l), c && l.isHidden ? o.push(l) : c || l.isHidden || s.push(l)
            }
        }
    ...
    var f = function () {
        function t(t) {
            ...
            var i = c(t).split(" "), o = i[0], s = o.match(/^\[(.+)\]$/), n = s && s[1], r = e(n, o), a = p.sortDataParsers[i[1]];
    ...
    p.sortDataParsers = {
        ...
        if (e.length) {
            var i, o, s = e.length;
            for (i = 0; s > i; i++)o = e[i], this.element.appendChild(o.element);
    ...
    var e, i, o = {}, s = document, n = window, r = s.documentElement, a = t.expando;
    t.event.special.inview = {
        add: function (e) {
            o[e.guid + "-" + this[a]] = {data: e, $element: t(this)}
        }, remove: function (t) {
            try {
    ...
    }, t(n).bind("scroll resize", function () {
        e = i = null
        ...
        if (t.each(o, function (t, e) {
                var i = e.data.selector, o = e.$element;
                l = l.add(i ? o.find(i) : o)
            }), a = l.length) {
            var d;
            if (!(d = e)) {
                var u = {height: n.innerHeight, width: n.innerWidth};
                u.height || !(d = s.compatMode) && t.support.boxModel || (d = "CSS1Compat" === d ? r : s.body, u = {
                    height: d.clientHeight,
                    width: d.clientWidth
                }), d = u
            }
            for (e = d, i = i || {
                top: n.pageYOffset || r.scrollTop || s.body.scrollTop,
                left: n.pageXOffset || r.scrollLeft || s.body.scrollLeft
            }; a > c; c++)if (t.contains(r, l[c])) {
                d = t(l[c]);
                var p = d.height(), f = d.width(), h = d.offset(), u = d.data("inview");
                if (!i || !e)break;
                h.top + p > i.top && h.top < i.top + e.height && h.left + f > i.left && h.left < i.left + e.width ? (f = i.left > h.left ? "right" : i.left + e.width < h.left + f ? "left" : "both", p = i.top > h.top ? "bottom" : i.top + e.height < h.top + p ? "top" : "both", h = f + "-" + p, (!u || u !== h) && d.data("inview", h).trigger("inview", [!0, f, p])) : u && d.data("inview", !1).trigger("inview", [!1])
            }
        }
    }, 250)
}(jQuery), !function (t) {
    ...
    function i(t) {
        return function (e) {
            ...
            if (i)for (var s = 0, n = i.length; n > s; ++s) {
                var r = i[s].match(/%(-|!)?([a-zA-Z]{1})(:[^;]+;)?/), l = new RegExp(r[0]), c = r[1] || "", d = r[3] || "", u = null;
                r = r[2], a.hasOwnProperty(r) && (u = a[r], u = Number(t[u])), null !== u && ("!" === c && (u = o(d, u)), "" === c && 10 > u && (u = "0" + u.toString()), e = e.replace(l, u.toString()))
            }
            return e = e.replace(/%%/, "%")
        }
    }
    ...
    var a = {
        ...
        this.el = e, this.$el = t(e), this.interval = null, this.offset = {}, this.instanceNumber = n.length, n.push(this), this.$el.data("countdown-instance", this.instanceNumber), o && (this.$el.on("update.countdown", o), this.$el.on("stoped.countdown", o), this.$el.on("finish.countdown", o)), this.setFinalDate(i), this.start()
    };
    ...
    var e = {
        ...
        getWidthFrom: "",
        responsiveWidth: !1
    }, i = t(window), o = t(document), s = [], n = i.height(), r = function () {
        for (var e = i.scrollTop(), r = o.height(), a = r - n, l = e > a ? a - e : 0, c = 0; c < s.length; c++) {
            var d = s[c], u = d.stickyWrapper.offset().top, p = u - d.topSpacing - l;
            if (p >= e)null !== d.currentTop && (d.stickyElement.css("position", "").css("top", ""), d.stickyElement.trigger("sticky-end", [d]).parent().removeClass(d.className), d.currentTop = null); else {
                var f = r - d.stickyElement.outerHeight() - d.topSpacing - d.bottomSpacing - e - l;
                0 > f ? f += d.topSpacing : f = d.topSpacing, d.currentTop != f && (d.stickyElement.css("position", "fixed").css("top", f), "undefined" != typeof d.getWidthFrom && d.stickyElement.css("width", t(d.getWidthFrom).width()), d.stickyElement.trigger("sticky-start", [d]).parent().addClass(d.className), d.currentTop = f)
            }
        }
    }, a = function () {
        n = i.height();
        ...
        init: function (i) {
            var o = t.extend({}, e, i);
            return this.each(function () {
                var i = t(this), n = i.attr("id"), r = (n ? n + "-" + e.wrapperClassName : e.wrapperClassName, t("<div></div>").attr("id", n + "-sticky-wrapper").addClass(o.wrapperClassName));
                i.wrapAll(r), o.center && i.parent().css({
                    width: i.outerWidth(),
                    marginLeft: "auto",
                    marginRight: "auto"
                }), "right" == i.css("float") && i.css({"float": "none"}).parent().css({"float": "right"});
                var a = i.parent();
            ...
            return this.each(function () {
                for (var e = t(this), i = -1, o = 0; o < s.length; o++)s[o].stickyElement.get(0) == e.get(0) && (i = o);
    ...
    var e, i, o, s, n, r, a, l = "Close", c = "BeforeClose", d = "AfterClose", u = "BeforeAppend", p = "MarkupParse", f = "Open", h = "Change", m = "mfp", g = "." + m, v = "mfp-ready", y = "mfp-removing", b = "mfp-prevent-close", w = function () {
    }, T = !!window.jQuery, _ = t(window), S = function (t, i) {
        e.ev.on(m + t + g, i)
    }, P = function (e, i, o, s) {
    ...
    w.prototype = {
        constructor: w, init: function () {
            ...
            C("BeforeOpen"), e.st.showCloseBtn && (e.st.closeBtnInside ? (S(p, function (t, e, i, o) {
                i.close_replaceWith = x(o.type)
            }), r += " mfp-close-btn-in") : e.wrap.append(x())), e.st.alignTop && (r += " mfp-align-top"), e.wrap.css(e.fixedContentPos ? {
            ...
            return e.isIE7 && (y += " mfp-ie7"), y && e._addClassToMFP(y), e.updateItemHTML(), C("BuildControls"), t("html").css(h), e.bgOverlay.add(e.wrap).prependTo(e.st.prependTo || o), e._lastFocusedEl = document.activeElement, setTimeout(function () {
                e.content ? (e._addClassToMFP(v), e._setFocus()) : e.bgOverlay.addClass(v), s.on("focusin" + g, e._onFocusIn)
            }, 16), e.isOpen = !0, e.updateSize(u), C(f), i
        }, close: function () {
            ...
            e.content = t, t ? e.st.showCloseBtn && e.st.closeBtnInside && e.currTemplate[i] === !0 ? e.content.find(".mfp-close").length || e.content.append(x()) : e.content = t : e.content = "", C(u), e.container.addClass("mfp-" + i + "-holder"), e.contentContainer.append(e.content)
        }, parseEl: function (i) {
            var o, s = e.items[i];
            ...
            if (e.preloader) {
                ...
                C("UpdateStatus", s), t = s.status, o = s.text, e.preloader.html(o), e.preloader.find("a").on("click", function (t) {
        ...
        if ("string" == typeof i)if ("open" === i) {
            var s, n = T ? o.data("magnificPopup") : o[0].magnificPopup, r = parseInt(arguments[1], 10) || 0;
            n.items ? s = n.items[r] : (s = o, n.delegate && (s = s.find(n.delegate)), s = s.eq(r)), e._openClick({mfpEl: s}, o, n)
        } else e.isOpen && e[i].apply(e, Array.prototype.slice.call(arguments, 1)); else i = t.extend(!0, {}, i), T ? o.data("magnificPopup", i) : o[0].magnificPopup = i, e.addGroup(o, i);
        return o
    };
    var j, I, z, O = "inline", Y = function () {
        z && (I.after(z.addClass(j)).detach(), z = null)
    };
    t.magnificPopup.registerModule(O, {
        options: {hiddenClass: "hide", markup: "", tNotFound: "Content not found"},
        proto: {
            initInline: function () {
                e.types.push(O), S(l + "." + O, function () {
                    Y()
                })
                ...
                if (Y(), i.src) {
                    ...
                    if (n.length) {
                        ...
                        r && r.tagName && (I || (j = s.hiddenClass, I = P(j), j = "mfp-" + j), z = n.after(I).detach().removeClass(j)), e.updateStatus("ready")
    ...
    t.magnificPopup.registerModule(A, {
        options: {
            ...
            initAjax: function () {
                e.types.push(A), E = e.st.ajax.cursor, S(l + "." + A, Q), S("BeforeChange." + A, Q)
            }, getAjax: function (i) {
                E && o.addClass(E), e.updateStatus("loading");
                var s = t.extend({
                    url: i.src, success: function (o, s, n) {
                        var r = {data: o, xhr: n};
                        C("ParseAjax", r), e.appendContent(t(r.data), A), i.finished = !0, M(), e._setFocus(), setTimeout(function () {
                            e.wrap.addClass(v)
    ...
    t.magnificPopup.registerModule("image", {
        options: {
            ...
            initImage: function () {
                ...
                e.types.push("image"), S(f + i, function () {
                    "image" === e.currItem.type && t.cursor && o.addClass(t.cursor)
                }), S(l + i, function () {
                    t.cursor && o.removeClass(t.cursor), _.off("resize" + g)
                ...
                var i = 0, o = t.img[0], s = function (n) {
                    L && clearInterval(L), L = setInterval(function () {
                        return o.naturalWidth > 0 ? void e._onImageHasSize(t) : (i > 200 && clearInterval(L), i++, void(3 === i ? s(10) : 40 === i ? s(50) : 100 === i && s(500)))
                    }, n)
                };
                s(1)
            }, getImage: function (i, o) {
                var s = 0, n = function () {
                    i && (i.img[0].complete ? (i.img.off(".mfploader"), i === e.currItem && (e._onImageHasSize(i), e.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, C("ImageLoadComplete")) : (s++, 200 > s ? setTimeout(n, 100) : r()))
                }, r = function () {
                    i && (i.img.off(".mfploader"), i === e.currItem && (e._onImageHasSize(i), e.updateStatus("error", a.tError.replace("%url%", i.src))), i.hasSize = !0, i.loaded = !0, i.loadError = !0)
                }, a = e.st.image, l = o.find(".mfp-img");
                if (l.length) {
                    var c = document.createElement("img");
                    c.className = "mfp-img", i.img = t(c).on("load.mfploader", n).on("error.mfploader", r), c.src = i.src, l.is("img") && (i.img = i.img.clone()), c = i.img[0], c.naturalWidth > 0 ? i.hasSize = !0 : c.width || (i.hasSize = !1)
                }
        ...
        options: {
            ...
            initZoom: function () {
                ...
                if (i.enabled && e.supportsTransition) {
                    var s, n, r = i.duration, a = function (t) {
                        var e = t.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image"), o = "all " + i.duration / 1e3 + "s " + i.easing, s = {
                            position: "fixed",
                            zIndex: 9999,
                            left: 0,
                            top: 0,
                    ...
                    S("BuildControls" + o, function () {
                        if (e._allowZoom()) {
                            ...
                            n = a(t), n.css(e._getOffset()), e.wrap.append(n), s = setTimeout(function () {
                                n.css(e._getOffset(!0)), s = setTimeout(function () {
                                    d(), setTimeout(function () {
                                        n.remove(), t = n = null, C("ZoomAnimationEnded")
                                    }, 16)
                                }, r)
                            }, 16)
                        }
                ...
                var a = {width: o.width(), height: (T ? o.innerHeight() : o[0].offsetHeight) - r - n};
                return H() ? a["-moz-transform"] = a.transform = "translate(" + s.left + "px," + s.top + "px)" : (a.left = s.left, a.top = s.top), a
            }
        }
    });
    var D = "iframe", W = "//about:blank", F = function (t) {
        if (e.currTemplate[D]) {
    ...
    t.magnificPopup.registerModule(D, {
        options: {
            ...
            initIframe: function () {
                e.types.push(D), S("BeforeChange", function (t, e, i) {
                    e !== i && (e === D ? F() : i === D && F(!0))
                }), S(l + "." + D, function () {
                    F()
                })
    ...
    t.magnificPopup.registerModule("gallery", {
        options: {
            ...
            initGallery: function () {
                var i = e.st.gallery, o = ".mfp-gallery", n = Boolean(t.fn.mfpFastClick);
                return e.direction = !0, i && i.enabled ? (r += " mfp-gallery", S(f + o, function () {
                ...
                }), S(p + o, function (t, o, s, n) {
                    var r = e.items.length;
                    s.counter = r > 1 ? V(i.tCounter, n.index, r) : ""
                }), S("BuildControls" + o, function () {
                    if (e.items.length > 1 && i.arrows && !e.arrowLeft) {
                        var o = i.arrowMarkup, s = e.arrowLeft = t(o.replace(/%title%/gi, i.tPrev).replace(/%dir%/gi, "left")).addClass(b), r = e.arrowRight = t(o.replace(/%title%/gi, i.tNext).replace(/%dir%/gi, "right")).addClass(b), a = n ? "mfpFastClick" : "click";
                        s[a](function () {
                            e.prev()
                        }), r[a](function () {
                            e.next()
                        }), e.isIE7 && (P("b", s[0], !1, !0), P("a", s[0], !1, !0), P("b", r[0], !1, !0), P("a", r[0], !1, !0)), e.container.append(s.add(r))
                    }
                }), S(h + o, function () {
                    ...
                    s.off(o), e.wrap.off("click" + o), e.arrowLeft && n && e.arrowLeft.add(e.arrowRight).destroyMfpFastClick(), e.arrowRight = e.arrowLeft = null
                })) : !1
            }, next: function () {
    ...
    t.magnificPopup.registerModule(q, {
        ...
        t.fn.mfpFastClick = function (s) {
            return t(this).each(function () {
                ...
                if (i) {
                    ...
                    a.on("touchstart" + n, function (t) {
                        u = !1, f = 1, p = t.originalEvent ? t.originalEvent.touches[0] : t.touches[0], c = p.clientX, d = p.clientY, _.on("touchmove" + n, function (t) {
                            ...
                            o(), u || f > 1 || (r = !0, t.preventDefault(), clearTimeout(l), l = setTimeout(function () {
                                r = !1
                            }, e), s())
                        })
                    })
            ...
            t(this).off("touchstart" + n + " click" + n), i && _.off("touchmove" + n + " touchend" + n)
        }
    }(), k()
}(window.jQuery || window.Zepto), !function (t) {
    t.fn.theiaStickySidebar = function (e) {
        var i = {
            containerSelector: "", additionalMarginTop: 0, additionalMarginBottom: 0, updateSidebarHeight: !0,
            minWidth: 0
        };
        e = t.extend(i, e), e.additionalMarginTop = parseInt(e.additionalMarginTop) || 0, e.additionalMarginBottom = parseInt(e.additionalMarginBottom) || 0, t("head").append(t('<style>.theiaStickySidebar:after {content: ""; display: table; clear: both;}</style>')), this.each(function () {
            ...
            s.stickySidebar.css("padding-top", 1), s.stickySidebar.css("padding-bottom", 1), n -= s.stickySidebar.offset().top, r = s.stickySidebar.outerHeight() - r - n, 0 == n ? (s.stickySidebar.css("padding-top", 0), s.stickySidebarPaddingTop = 0) : s.stickySidebarPaddingTop = 1, 0 == r ? (s.stickySidebar.css("padding-bottom", 0), s.stickySidebarPaddingBottom = 0) : s.stickySidebarPaddingBottom = 1, s.previousScrollTop = null, s.fixedScrollTop = 0, i(), s.onScroll = function (s) {
                if (s.stickySidebar.is(":visible")) {
                    ...
                    var n = t(document).scrollTop(), r = "static";
                    if (n >= s.container.offset().top + (s.paddingTop + s.marginTop - s.options.additionalMarginTop)) {
                        var a, l = s.paddingTop + s.marginTop + e.additionalMarginTop, c = s.paddingBottom + s.marginBottom + e.additionalMarginBottom, d = s.container.offset().top, u = s.container.offset().top + o(s.container), p = 0 + e.additionalMarginTop, f = s.stickySidebar.outerHeight() + l + c < t(window).height();
                        a = f ? p + s.stickySidebar.outerHeight() : t(window).height() - s.marginBottom - s.paddingBottom - e.additionalMarginBottom;
                        var h = d - n + s.paddingTop + s.marginTop, m = u - n - s.paddingBottom - s.marginBottom, g = s.stickySidebar.offset().top - n, v = s.previousScrollTop - n;
                        "fixed" == s.stickySidebar.css("position") && (g += v), g = v > 0 ? Math.min(g, p) : Math.max(g, a - s.stickySidebar.outerHeight()), g = Math.max(g, h), g = Math.min(g, m - s.stickySidebar.outerHeight());
                        var y = s.container.height() == s.stickySidebar.outerHeight();
                        r = !y && g == p || !y && g == a - s.stickySidebar.outerHeight() ? "fixed" : n + g - s.sidebar.offset().top - s.paddingTop <= e.additionalMarginTop ? "static" : "absolute"
                    }
                    if ("fixed" == r)s.stickySidebar.css({
                        ...
                        var b = {};
                        "absolute" != s.stickySidebar.css("position") && (b.position = "absolute", b.top = n + g - s.sidebar.offset().top - s.stickySidebarPaddingTop - s.stickySidebarPaddingBottom), b.width = s.sidebar.width(), b.left = "", s.stickySidebar.css(b)
                    } else"static" == r && i();
                    "static" != r && 1 == s.options.updateSidebarHeight && s.sidebar.css({"min-height": s.stickySidebar.outerHeight() + s.stickySidebar.offset().top - s.sidebar.offset().top + s.paddingBottom}), s.previousScrollTop = n
                }
    ...
    t.fn.doubleTouchToGo = function () {
        return "ontouchstart"in e || navigator.msMaxTouchPoints || navigator.userAgent.toLowerCase().match(/windows phone os 7/i) ? (this.each(function () {
            ...
            t(this).on("click", function (i) {
                ...
                for (var o = !0, s = t(i.target).parents(), n = 0; n < s.length; n++)s[n] == e[0] && (o = !1);
                o && (e = !1)
            })
        }), this) : !1
    }
    ...
    jQuery.fn.CSSAnimate = function (t, e, i, o, s) {
        return this.each(function () {
            var n = jQuery(this);
            if (0 !== n.length && t) {
                if ("function" == typeof e && (s = e, e = jQuery.fx.speeds._default), "function" == typeof i && (s = i, i = 0), "function" == typeof o && (s = o, o = "cubic-bezier(0.65,0.03,0.36,0.72)"), "string" == typeof e)for (var r in jQuery.fx.speeds) {
                    if (e == r) {
                ...
                if (jQuery.support.transition) {
                    ...
                    for (d in t) {
                        var c = d;
                        "transform" === c && (c = a + "transform", t[c] = t[d], delete t[d]), "transform-origin" === c && (c = a + "transform-origin", t[c] = t[d], delete t[d]), r.push(c), n.css(c) || n.css(c, 0)
                    }
                    d = r.join(","), n.css(a + "transition-property", d), n.css(a + "transition-duration", e + "ms"), n.css(a + "transition-delay", i + "ms"), n.css(a + "transition-timing-function", o), n.css(a + "backface-visibility", "hidden"), setTimeout(function () {
                        n.css(t)
                    }, 0), setTimeout(function () {
                        n.called || !s ? n.called = !1 : s()
                    }, e + 20), n.on(l, function (t) {
                        return n.off(l), n.css(a + "transition", ""), t.stopPropagation(), "function" == typeof s && (n.called = !0, s()), !1
                    })
                } else {
                    for (var d in t)"transform" === d && delete t[d], "transform-origin" === d && delete t[d], "auto" === t[d] && delete t[d];
                    s && "string" != typeof s || (s = "linear"), n.animate(t, e, s)
                }
            }
        })
                                    ...
                                    onReady: function (t) {
                                        ...
                                        if ("function" == typeof t.target.getPlayerState) {
                                            ...
                                            if (0 == e) {
                                                ...
                                                var s = YTPlayer.opt.startAt ? YTPlayer.opt.startAt : 1;
                                                o.loop ? (YTPlayer.wrapper.css({opacity: 0}), $YTPlayer.playYTP(), YTPlayer.player.seekTo(s, !0)) : YTPlayer.isBackground || (YTPlayer.player.seekTo(s, !0), $YTPlayer.playYTP(), setTimeout(function () {
                                                    $YTPlayer.pauseYTP()
                                                }, 10)), !o.loop && YTPlayer.isBackground ? YTPlayer.wrapper.CSSAnimate({opacity: 0}, 2e3) : o.loop && (YTPlayer.wrapper.css({opacity: 0}), YTPlayer.loop++), i.find(".mb_YTVPPlaypause").html(jQuery.mbYTPlayer.controls.play), jQuery(YTPlayer).trigger("YTPEnd")
                                            }
                                            if (3 == e) {
                                                if (YTPlayer.state == e)return;
        ...
        changeMovie: function (t) {
            ...
            if (jQuery(e).getPlayer().cueVideoByUrl(encodeURI(jQuery.mbYTPlayer.locationProtocol + "//www.youtube.com/v/" + e.videoID), 5, e.opt.quality), setTimeout(function () {
                ...
                var s = window.retina || window.devicePixelRatio > 1;
                e.overlay.addClass(s ? "raster retina" : "raster")
        ...
        fullscreen: function (t) {
            function e(t, e) {
                for (var i, o, s = ["webkit", "moz", "ms", "o", ""], n = 0; n < s.length && !t[i];) {
                    if (i = e, "" == s[n] && (i = i.substr(0, 1).toLowerCase() + i.substr(1)), i = s[n] + i, o = typeof t[i], "undefined" != o)return s = [s[n]], "function" == o ? t[i]() : t[i];
                    n++
                }
            }
            ...
            var s = this.get(0), n = jQuery("#controlBar_" + s.id), r = n.find(".mb_OnlyYT"), a = jQuery(s.wrapper);
            if (t) {
                ...
                jQuery(document).off(l), jQuery(document).on(l, function () {
                    ...
                    t ? jQuery(s).setVideoQuality("default") : (jQuery(s).removeClass("fullscreen"), s.isAlone = !1, r.html(jQuery.mbYTPlayer.controls.onlyYT), jQuery(s).setVideoQuality(s.opt.quality), s.isBackground ? jQuery("body").after(n) : s.wrapper.before(n), jQuery(window).resize())
                })
            }
            s.isAlone ? (t ? o() : a.CSSAnimate({opacity: s.opt.opacity}, 500), jQuery(s).trigger("YTPFullScreenEnd"), a.css({zIndex: -1}), r.html(jQuery.mbYTPlayer.controls.onlyYT), s.isAlone = !1) : (1 != s.player.getPlayerState() && 2 != s.player.getPlayerState() && jQuery(s).playYTP(), t ? (s.wrapper.append(n), jQuery(s).addClass("fullscreen"), i(a.get(0))) : a.css({zIndex: 1e4}).CSSAnimate({opacity: 1}, 1e3, 0), jQuery(s).trigger("YTPFullScreenStart"), r.html(jQuery.mbYTPlayer.controls.showSite), s.isAlone = !0)
        },
        playYTP: function () {
        ...
        manageYTPProgress: function () {
            var t = this.get(0), e = jQuery("#controlBar_" + t.id), i = e.find(".mb_YTVPProgress"), o = e.find(".mb_YTVPLoaded"), s = e.find(".mb_YTVTime"), n = i.outerWidth(), r = Math.floor(t.player.getCurrentTime()), a = Math.floor(t.player.getDuration()), l = r * n / a, c = 0, d = 100 * t.player.getVideoLoadedFraction();
            return o.css({left: c, width: d + "%"}), s.css({left: 0, width: l}), {totalTime: a, currentTime: r}
        },
        buildYTPControls: function () {
            ...
            if (!jQuery("#controlBar_" + t.id).length) {
                ...
                }).hide(), o = jQuery("<div/>").addClass("buttonBar"), s = jQuery("<span>" + jQuery.mbYTPlayer.controls.play + "</span>").addClass("mb_YTVPPlaypause ytpicon").click(function () {
                ...
                var l = jQuery("<span/>").html(jQuery.mbYTPlayer.controls.ytLogo).addClass("mb_YTVPUrl ytpicon").attr("title", "view on YouTube").on("click", function () {
                ...
                }), c = jQuery("<span/>").html(jQuery.mbYTPlayer.controls.onlyYT).addClass("mb_OnlyYT ytpicon").on("click", function () {
                    jQuery(t).fullscreen(e.realfullscreen)
                }), d = jQuery("<div/>").addClass("mb_YTVPProgress").css("position", "absolute").click(function (e) {
                    ...
                    t["goto"] = p.outerWidth() * o / d.outerWidth(), t.player.seekTo(parseFloat(t["goto"]), !0), i.find(".mb_YTVPLoaded").css({width: 0})
                }), u = jQuery("<div/>").addClass("mb_YTVPLoaded").css("position", "absolute"), p = jQuery("<div/>").addClass("mb_YTVTime").css("position", "absolute");
                d.append(u).append(p), o.append(s).append(n).append(r), e.printUrl && o.append(l), (t.isBackground || t.opt.realfullscreen && !t.isBackground) && o.append(c), i.append(o).append(d), t.isBackground ? jQuery("body").after(i) : (i.addClass("inlinePlayer"), t.wrapper.before(i)), i.fadeIn()
            }
        },
        checkForState: function (t) {
            var e = jQuery("#controlBar_" + t.id), i = t.opt, o = t.opt.startAt ? t.opt.startAt : 1;
            t.getState = setInterval(function () {
                var s = jQuery(t).manageYTPProgress();
                e.find(".mb_YTVPTime").html(jQuery.mbYTPlayer.formatTime(s.currentTime) + " / " + jQuery.mbYTPlayer.formatTime(s.totalTime)), parseFloat(t.player.getDuration() - 3) < t.player.getCurrentTime() && 1 == t.player.getPlayerState() && !t.isPlayList && (i.loop ? t.player.seekTo(o) : (t.player.pauseVideo(), t.wrapper.CSSAnimate({opacity: 0}, 2e3, function () {
        ...
        var t = this.get(0), e = t.opt, i = jQuery(t.playerEl), o = {}, s = t.isBackground ? jQuery(window) : e.containment;
        o.width = s.width(), o.height = s.height();
        var n = 24, r = {};
        r.width = o.width + o.width * n / 100, r.height = Math.ceil("16/9" == e.ratio ? 9 * o.width / 16 : 3 * o.width / 4), r.marginTop = -((r.height - o.height) / 2), r.marginLeft = -(o.width * (n / 2) / 100), r.height < o.height && (r.height = o.height + o.height * n / 100, r.width = Math.floor("16/9" == e.ratio ? 16 * o.height / 9 : 4 * o.height / 3), r.marginTop = -(o.height * (n / 2) / 100), r.marginLeft = -((r.width - o.width) / 2)), i.css({
            width: r.width,
            height: r.height,
        ...
        for (var e = t.slice(), i = e.length, o = i; o--;) {
            var s = parseInt(Math.random() * i), n = e[o];
            e[o] = e[s], e[s] = n
        }
        return e
    ...
    e.prototype.getSuffix = function (t, e) {
        var i, o;
        for (i = t > e ? t : e, o = 0; o < this.suffixRanges.length; o++)if (i <= this.suffixRanges[o])return this.settings.sizeRangeSuffixes[this.suffixRanges[o]];
        ...
        var o;
        if (this.settings.thumbnailPath)o = this.settings.thumbnailPath(t, e, i); else {
            var s = t.match(this.settings.extension), n = null !== s ? s[0] : "";
            o = t.replace(this.settings.extension, ""), o = this.removeSuffix(o, this.getUsedSuffix(o)), o += this.getSuffix(e, i) + n
        }
        return o
    ...
    }, e.prototype.displayEntry = function (e, i, o, s, n, r) {
        e.width(s), e.height(r), e.css("top", o), e.css("left", i);
        var a = this.imgFromEntry(e);
        if (null !== a) {
            a.css("width", s), a.css("height", n), a.css("margin-left", -s / 2), a.css("margin-top", -n / 2);
            var l = a.attr("src"), c = this.newSrc(l, s, n);
        ...
        if (null !== i && this.settings.captions) {
            ...
            if (null === o) {
                var s = i.attr("alt");
                this.isValidCaption(s) || (s = e.attr("title")), this.isValidCaption(s) && (o = t('<div class="caption">' + s + "</div>"), e.append(o), e.data("jg.createdCaption", !0))
            }
        ...
        var e, i, o, s, n, r = !0, a = 0, l = this.galleryWidth - 2 * this.border - (this.buildingRow.entriesBuff.length - 1) * this.settings.margins, c = l / this.buildingRow.aspectRatio, d = this.buildingRow.width / l > this.settings.justifyThreshold;
        ...
        for (t && !d && "justify" !== this.settings.lastRow && "hide" !== this.settings.lastRow && (r = !1), e = 0; e < this.buildingRow.entriesBuff.length; e++)i = this.buildingRow.entriesBuff[e], o = i.data("jg.width") / i.data("jg.height"), r ? (s = e === this.buildingRow.entriesBuff.length - 1 ? l : c * o, n = c) : (s = this.settings.rowHeight * o, n = this.settings.rowHeight), l -= Math.round(s), i.data("jg.jwidth", Math.round(s)), i.data("jg.jheight", Math.ceil(n)), (0 === e || a > n) && (a = n);
        ...
        var e, i, o, s = this.settings, n = this.border;
        if (i = this.prepareBuildingRow(t), t && "hide" === s.lastRow && -1 === this.buildingRow.height)return void this.clearBuildingRow();
        if (this.maxRowHeight.isPercentage ? this.maxRowHeight.value * s.rowHeight < this.buildingRow.height && (this.buildingRow.height = this.maxRowHeight.value * s.rowHeight) : this.maxRowHeight.value > 0 && this.maxRowHeight.value < this.buildingRow.height && (this.buildingRow.height = this.maxRowHeight.value), "center" === s.lastRow || "right" === s.lastRow) {
            ...
            "center" === s.lastRow ? n += r / 2 : "right" === s.lastRow && (n += r)
        }
        for (o = 0; o < this.buildingRow.entriesBuff.length; o++)e = this.buildingRow.entriesBuff[o], this.displayEntry(e, n, this.offY, e.data("jg.jwidth"), e.data("jg.jheight"), this.buildingRow.height), n += e.data("jg.jwidth") + s.margins;
        this.$gallery.height(this.offY + this.buildingRow.height + this.border + (this.isSpinnerActive() ? this.getSpinnerHeight() : 0)), (!t || this.buildingRow.height <= s.rowHeight && i) && (this.offY += this.buildingRow.height + s.margins, this.clearBuildingRow(), this.$gallery.trigger("jg.rowflush"))
        ...
        clearInterval(this.checkWidthIntervalId), t.each(this.entries, t.proxy(function (e, i) {
            ...
            var s = this.imgFromEntry(o);
            s.css("width", ""), s.css("height", ""), s.css("margin-left", ""), s.css("margin-top", ""), s.attr("src", s.data("jg.originalSrc")), s.data("jg.originalSrc", void 0), this.removeCaptionEventsHandlers(o);
            var n = this.captionFromEntry(o);
            o.data("jg.createdCaption") ? (o.data("jg.createdCaption", void 0), null !== n && n.remove()) : null !== n && n.fadeTo(0, 1)
        ...
        for (var i = this.lastAnalyzedIndex + 1; i < this.entries.length; i++) {
            ...
            if (o.data("jg.loaded") === !0 || "skipped" === o.data("jg.loaded")) {
                var s = this.galleryWidth - 2 * this.border - (this.buildingRow.entriesBuff.length - 1) * this.settings.margins, n = o.data("jg.width") / o.data("jg.height");
                if (s / (this.buildingRow.aspectRatio + n) < this.settings.rowHeight && (this.flushRow(!1), ++this["yield"].flushed >= this["yield"].every))return void this.startImgAnalyzer(e);
                this.buildingRow.entriesBuff.push(o), this.buildingRow.aspectRatio += n, this.buildingRow.width += n * this.settings.rowHeight, this.lastAnalyzedIndex = i
        ...
        if (i || o) {
            var s = new Image, n = t(s);
            i && n.one("load", function () {
                n.off("load error"), i(s)
            }), o && n.one("error", function () {
                n.off("load error"), o(s)
            }), s.src = e
        }
    }, e.prototype.init = function () {
        var e = !1, i = !1, o = this;
        t.each(this.entries, function (s, n) {
            var r = t(n), a = o.imgFromEntry(r);
            if (r.addClass("jg-entry"), r.data("jg.loaded") !== !0 && "skipped" !== r.data("jg.loaded"))if (null !== o.settings.rel && r.attr("rel", o.settings.rel), null !== o.settings.target && r.attr("target", o.settings.target), null !== a) {
                var l = o.extractImgSrcFromImage(a);
                if (a.attr("src", l), o.settings.waitThumbnailsLoad === !1) {
                    var c = parseFloat(a.attr("width")), d = parseFloat(a.attr("height"));
                    if (!isNaN(c) && !isNaN(d))return r.data("jg.width", c), r.data("jg.height", d), r.data("jg.loaded", "skipped"), i = !0, o.startImgAnalyzer(!1), !0
                }
        ...
        for (var o = {0: ""}, s = 0; s < e.length; s++)if ("string" === t.type(e[s]))try {
            var n = parseInt(e[s].replace(/^[a-z]+/, ""), 10);
            o[n] = this.settings.sizeRangeSuffixes[e[s]]
        } catch (r) {
            throw"sizeRangeSuffixes keys must contains correct numbers (" + r + ")"
        } else o[e[s]] = this.settings.sizeRangeSuffixes[e[s]];
        this.settings.sizeRangeSuffixes = o
    }, e.prototype.retrieveMaxRowHeight = function () {
        var e = {};
        if ("string" === t.type(this.settings.maxRowHeight))this.settings.maxRowHeight.match(/^[0-9]+%$/) ? (e.value = parseFloat(this.settings.maxRowHeight.match(/^([0-9]+)%$/)[1]) / 100, e.isPercentage = !1) : (e.value = parseFloat(this.settings.maxRowHeight), e.isPercentage = !0); else {
        ...
        return this.each(function (o, s) {
            ...
            var r = n.data("jg.controller");
            if ("undefined" == typeof r) {
                if ("undefined" != typeof i && null !== i && "object" !== t.type(i)) {
                    if ("destroy" === i)return;
                    throw"The argument must be an object"
                }
                r = new e(n, t.extend({}, t.fn.justifiedGallery.defaults, i)), n.data("jg.controller", r)
    ...
    function sc_startScroll(t, e) {
        for (var i = 0, o = t.anims.length; o > i; i++) {
            var s = t.anims[i];
    ...
    function sc_fireCallbacks(t, e, i, o, s) {
        if (e[i] && e[i].call(t, o), s[i].length)for (var n = 0, r = s[i].length; r > n; n++)s[i][n].call(t, o);
        return []
    }
    ...
    function sc_mapCallbackArguments(t, e, i, o, s, n, r) {
        return {
            width: r.width,
            height: r.height,
            items: {old: t, skipped: e, visible: i},
            scroll: {items: o, direction: s, duration: n}
        }
    }

    function sc_getDuration(t, e, i, o) {
        var s = t.duration;
        return "none" == t.fx ? 0 : ("auto" == s ? s = e.scroll.duration / e.scroll.items * i : 10 > s && (s = o / s), 1 > s ? 0 : ("fade" == t.fx && (s /= 2), Math.round(s)))
    }

    function nv_showNavi(t, e, i) {
        var o = is_number(t.items.minimum) ? t.items.minimum : t.items.visible + 1;
        if ("show" == e || "hide" == e)var s = e; else if (o > e) {
            debug(i, "Not enough items (" + e + " total, " + o + " needed): Hiding navigation.");
            var s = "hide"
        } else var s = "show";
        var n = "show" == s ? "removeClass" : "addClass", r = cf_c("hidden", i);
        t.auto.button && t.auto.button[s]()[n](r), t.prev.button && t.prev.button[s]()[n](r), t.next.button && t.next.button[s]()[n](r), t.pagination.container && t.pagination.container[s]()[n](r)
    }

    function nv_enableNavi(t, e, i) {
        if (!t.circular && !t.infinite) {
            var o = "removeClass" == e || "addClass" == e ? e : !1, s = cf_c("disabled", i);
            if (t.auto.button && o && t.auto.button[o](s), t.prev.button) {
                var n = o || 0 == e ? "addClass" : "removeClass";
                t.prev.button[n](s)
            }
            if (t.next.button) {
                var n = o || e == t.items.visible ? "addClass" : "removeClass";
                t.next.button[n](s)
            }
        }
    }
    ...
    function gn_getItemIndex(t, e, i, o, s) {
        if (is_string(t) && (t = $(t, s)), is_object(t) && (t = $(t, s)), is_jquery(t) ? (t = s.children().index(t), is_boolean(i) || (i = !1)) : is_boolean(i) || (i = !0), is_number(t) || (t = 0), is_number(e) || (e = 0), i && (t += o.first), t += e, o.total > 0) {
            for (; t >= o.total;)t -= o.total;
            for (; 0 > t;)t += o.total
        }
        return t
    }
    ...
    function gn_getVisibleItemsPrev(t, e, i) {
        for (var o = 0, s = 0, n = i; n >= 0; n--) {
            var r = t.eq(n);
            if (o += r.is(":visible") ? r[e.d.outerWidth](!0) : 0, o > e.maxDimension)return s;
            0 == n && (n = t.length), s++
        }
    }
    ...
    function gn_getScrollItemsPrevFilter(t, e, i, o) {
        return gn_getItemsPrevFilter(t, e.items.filter, o, i)
    }

    function gn_getItemsPrevFilter(t, e, i, o) {
        for (var s = 0, n = 0, r = o, a = t.length; r >= 0; r--) {
            if (n++, n == a)return n;
            var l = t.eq(r);
            if (l.is(e) && (s++, s == i))return n;
            0 == r && (r = a)
        }
    }
    ...
    function gn_getVisibleItemsNext(t, e, i) {
        for (var o = 0, s = 0, n = i, r = t.length - 1; r >= n; n++) {
            var a = t.eq(n);
            if (o += a.is(":visible") ? a[e.d.outerWidth](!0) : 0, o > e.maxDimension)return s;
            if (s++, s == r + 1)return s;
            n == r && (n = -1)
        }
    }

    function gn_getVisibleItemsNextTestCircular(t, e, i, o) {
        var s = gn_getVisibleItemsNext(t, e, i);
        return e.circular || i + s > o && (s = o - i), s
    }
    ...
    function gn_getScrollItemsNextFilter(t, e, i, o) {
        return gn_getItemsNextFilter(t, e.items.filter, o + 1, i, e.circular) - 1
    }

    function gn_getItemsNextFilter(t, e, i, o, s) {
        for (var n = 0, r = 0, a = o, l = t.length - 1; l >= a; a++) {
            if (r++, r >= l)return r;
            var c = t.eq(a);
            if (c.is(e) && (n++, n == i))return r;
            a == l && (a = -1)
        }
    }
    ...
    function sz_storeMargin(t, e, i) {
        e.usePadding && (is_string(i) || (i = "_cfs_origCssMargin"), t.each(function () {
            var t = $(this), o = parseInt(t.css(e.d.marginRight), 10);
            is_number(o) || (o = 0), t.data(i, o)
        }))
    }

    function sz_resetMargin(t, e, i) {
        if (e.usePadding) {
            var o = is_boolean(i) ? i : !1;
            is_number(i) || (i = 0), sz_storeMargin(t, e, "_cfs_tempCssMargin"), t.each(function () {
                var t = $(this);
                t.css(e.d.marginRight, o ? t.data("_cfs_tempCssMargin") : i + t.data("_cfs_origCssMargin"))
            })
        }
    }
    ...
    function sz_setResponsiveSizes(t, e) {
        var i = (t.items.visible, t.items[t.d.width]), o = t[t.d.height], s = is_percentage(o);
        e.each(function () {
            var e = $(this), n = i - ms_getPaddingBorderMargin(e, t, "Width");
            e[t.d.width](n), s && e[t.d.height](ms_getPercentage(n, o))
        })
    }

    function sz_setSizes(t, e) {
        var i = t.parent(), o = t.children(), s = gi_getCurrentItems(o, e), n = cf_mapWrapperSizes(ms_getSizes(s, e, !0), e, !1);
        ...
        return t.css(e.d.width, n[e.d.width] + 2 * ms_getTotalSize(o, e, "width")), t.css(e.d.height, ms_getLargestSize(o, e, "height")), n
    }
    ...
    function ms_getLargestSize(t, e, i, o) {
        return is_boolean(o) || (o = !1), is_number(e[e.d[i]]) && o ? e[e.d[i]] : is_number(e.items[e.d[i]]) ? e.items[e.d[i]] : (i = i.toLowerCase().indexOf("width") > -1 ? "outerWidth" : "outerHeight", ms_getTrueLargestSize(t, e, i))
    }

    function ms_getTrueLargestSize(t, e, i) {
        for (var o = 0, s = 0, n = t.length; n > s; s++) {
    ...
    function ms_getTotalSize(t, e, i, o) {
        if (is_boolean(o) || (o = !1), is_number(e[e.d[i]]) && o)return e[e.d[i]];
        if (is_number(e.items[e.d[i]]))return e.items[e.d[i]] * t.length;
        for (var s = i.toLowerCase().indexOf("width") > -1 ? "outerWidth" : "outerHeight", n = 0, r = 0, a = t.length; a > r; r++) {
            var l = t.eq(r);
            n += l.is(":visible") ? l[e.d[s]](!0) : 0
        }
        return n
    }
    ...
    function ms_hasVariableSizes(t, e, i) {
        for (var o = !1, s = !1, n = 0, r = t.length; r > n; n++) {
            var a = t.eq(n), l = a.is(":visible") ? a[e.d[i]](!0) : 0;
            o === !1 ? o = l : o != l && (s = !0), 0 == o && (s = !0)
        }
        return s
    }
    ...
    function cf_e(t, e, i, o, s) {
        return is_boolean(i) || (i = !0), is_boolean(o) || (o = !0), is_boolean(s) || (s = !1), i && (t = e.events.prefix + t), o && (t = t + "." + e.events.namespace), o && s && (t += e.serialNumber), t
    }
    ...
    function cf_mapWrapperSizes(t, e, i) {
        is_boolean(i) || (i = !0);
        var o = e.usePadding && i ? e.padding : [0, 0, 0, 0], s = {};
        return s[e.d.width] = t[0] + o[1] + o[3], s[e.d.height] = t[1] + o[0] + o[2], s
    }

    function cf_sortParams(t, e) {
        for (var i = [], o = 0, s = t.length; s > o; o++)for (var n = 0, r = e.length; r > n; n++)if (e[n].indexOf(typeof t[o]) > -1 && is_undefined(i[n])) {
            i[n] = t[o];
            break
        }
        return i
    ...
    function cf_getDimensions(t) {
        for (var e = [["width", "innerWidth", "outerWidth", "height", "innerHeight", "outerHeight", "left", "top", "marginRight", 0, 1, 2, 3], ["height", "innerHeight", "outerHeight", "width", "innerWidth", "outerWidth", "top", "left", "marginBottom", 3, 2, 1, 0]], i = e[0].length, o = "right" == t.direction || "left" == t.direction ? 0 : 1, s = {}, n = 0; i > n; n++)s[e[0][n]] = e[o][n];
        return s
    }

    function cf_getAdjust(t, e, i, o) {
        var s = t;
        if (is_function(i))s = i.call(o, s); else if (is_string(i)) {
            var n = i.split("+"), r = i.split("-");
            if (r.length > n.length)var a = !0, l = r[0], c = r[1]; else var a = !1, l = n[0], c = n[1];
            switch (l) {
                case"even":
                    s = t % 2 == 1 ? t - 1 : t;
                    break;
    ...
    function cf_getItemsAdjust(t, e, i, o) {
        return cf_getItemAdjustMinMax(cf_getAdjust(t, e, i, o), e.items.visibleConf)
    }
    ...
    function cf_setCookie(t, e, i) {
        if (t) {
            var o = e.triggerHandler(cf_e("currentPosition", i));
            $.fn.carouFredSel.cookie.set(t, o)
        }
    }
    ...
    function in_mapCss(t, e) {
        for (var i = {}, o = 0, s = e.length; s > o; o++)i[e[o]] = t.css(e[o]);
        return i
    }

    function in_complementItems(t, e, i, o) {
        return is_object(t.visibleConf) || (t.visibleConf = {}), is_object(t.sizesConf) || (t.sizesConf = {}), 0 == t.start && is_number(o) && (t.start = o), is_object(t.visible) ? (t.visibleConf.min = t.visible.min, t.visibleConf.max = t.visible.max, t.visible = !1) : is_string(t.visible) ? ("variable" == t.visible ? t.visibleConf.variable = !0 : t.visibleConf.adjust = t.visible, t.visible = !1) : is_function(t.visible) && (t.visibleConf.adjust = t.visible, t.visible = !1), is_string(t.filter) || (t.filter = i.filter(":hidden").length > 0 ? ":visible" : "*"), t[e.d.width] || (e.responsive ? (debug(!0, "Set a " + e.d.width + " for the items!"), t[e.d.width] = ms_getTrueLargestSize(i, e, "outerWidth")) : t[e.d.width] = ms_hasVariableSizes(i, e, "outerWidth") ? "variable" : i[e.d.outerWidth](!0)), t[e.d.height] || (t[e.d.height] = ms_hasVariableSizes(i, e, "outerHeight") ? "variable" : i[e.d.outerHeight](!0)), t.sizesConf.width = t.width, t.sizesConf.height = t.height, t
    }
    ...
    function in_getResponsiveValues(t, e, i) {
        var o = cf_getItemAdjustMinMax(Math.ceil(t[t.d.width] / t.items[t.d.width]), t.items.visibleConf);
        o > e.length && (o = e.length);
        var s = Math.floor(t[t.d.width] / o);
        return t.items.visible = o, t.items[t.d.width] = s, t[t.d.width] = o * s, t
    }
    ...
    $.fn.carouFredSel || ($.fn.caroufredsel = $.fn.carouFredSel = function (options, configs) {
        ...
        FN._init = function (t, e, i) {
            ...
            var o = $cfs.children(), s = ms_getParentSize($wrp, opts, "width");
            if (is_true(opts.cookie) && (opts.cookie = "caroufredsel_cookie_" + conf.serialNumber), opts.maxDimension = ms_getMaxDimension(opts, s), opts.items = in_complementItems(opts.items, opts, o, i), opts[opts.d.width] = in_complementPrimarySize(opts[opts.d.width], opts, o), opts[opts.d.height] = in_complementSecondarySize(opts[opts.d.height], opts, o), opts.responsive && (is_percentage(opts[opts.d.width]) || (opts[opts.d.width] = "100%")), is_percentage(opts[opts.d.width]) && (crsl.upDateOnWindowResize = !0, crsl.primarySizePercentage = opts[opts.d.width], opts[opts.d.width] = ms_getPercentage(s, crsl.primarySizePercentage), opts.items.visible || (opts.items.visibleConf.variable = !0)), opts.responsive ? (opts.usePadding = !1, opts.padding = [0, 0, 0, 0], opts.align = !1, opts.items.visibleConf.variable = !1) : (opts.items.visible || (opts = in_complementVisibleItems(opts, s)), opts[opts.d.width] || (!opts.items.visibleConf.variable && is_number(opts.items[opts.d.width]) && "*" == opts.items.filter ? (opts[opts.d.width] = opts.items.visible * opts.items[opts.d.width], opts.align = !1) : opts[opts.d.width] = "variable"), is_undefined(opts.align) && (opts.align = is_number(opts[opts.d.width]) ? "center" : !1), opts.items.visibleConf.variable && (opts.items.visible = gn_getVisibleItemsNext(o, opts, 0))), "*" == opts.items.filter || opts.items.visibleConf.variable || (opts.items.visibleConf.org = opts.items.visible, opts.items.visible = gn_getVisibleItemsNextFilter(o, opts, 0)), opts.items.visible = cf_getItemsAdjust(opts.items.visible, opts, opts.items.visibleConf.adjust, $tt0), opts.items.visibleConf.old = opts.items.visible, opts.responsive)opts.items.visibleConf.min || (opts.items.visibleConf.min = opts.items.visible), opts.items.visibleConf.max || (opts.items.visibleConf.max = opts.items.visible), opts = in_getResponsiveValues(opts, o, s); else switch (opts.padding = cf_getPadding(opts.padding), "top" == opts.align ? opts.align = "left" : "bottom" == opts.align && (opts.align = "right"), opts.align) {
                case"center":
                case"left":
                case"right":
                    "variable" != opts[opts.d.width] && (opts = in_getAlignPadding(opts, o), opts.usePadding = !0);
                    break;
                default:
            ...
            FN._unbind_events(), $cfs.bind(cf_e("stop", conf), function (t, e) {
                ...
                if (t.stopPropagation(), tmrs = sc_clearTimers(tmrs), e && crsl.isScrolling) {
                    scrl.isStopped = !0;
                    var o = getTime() - scrl.startTime;
                    scrl.duration -= o, scrl.pre && (scrl.pre.duration -= o), scrl.post && (scrl.post.duration -= o), sc_stopScroll(scrl, !1)
                }
                if (crsl.isPaused || crsl.isScrolling || i && (tmrs.timePassed += getTime() - tmrs.startTime), crsl.isPaused || opts.auto.button && opts.auto.button.addClass(cf_c("paused", conf)), crsl.isPaused = !0, opts.auto.onTimeoutPause) {
                    var s = opts.auto.timeoutDuration - tmrs.timePassed, n = 100 - Math.ceil(100 * s / opts.auto.timeoutDuration);
                    opts.auto.onTimeoutPause.call($tt0, n, s)
                }
                return !0
            }), $cfs.bind(cf_e("play", conf), function (t, e, i, o) {
                t.stopPropagation(), tmrs = sc_clearTimers(tmrs);
                var s = [e, i, o], n = ["string", "number", "boolean"], r = cf_sortParams(s, n);
                if (e = r[0], i = r[1], o = r[2], "prev" != e && "next" != e && (e = crsl.direction), is_number(i) || (i = 0), is_boolean(o) || (o = !1), o && (crsl.isStopped = !1, opts.auto.play = !0), !opts.auto.play)return t.stopImmediatePropagation(), debug(conf, "Carousel stopped: Not scrolling.");
            ...
            }), $cfs.bind(cf_e("prev", conf) + " " + cf_e("next", conf), function (t, e, i, o, s) {
                ...
                var r = [e, i, o, s], a = ["object", "number/string", "function", "boolean"], l = cf_sortParams(r, a);
                e = l[0], i = l[1], o = l[2], s = l[3];
                var c = t.type.slice(conf.events.prefix.length);
                if (is_object(e) || (e = {}), is_function(o) && (e.onAfter = o), is_boolean(s) && (e.queue = s), e = $.extend(!0, {}, opts[c], e), e.conditions && !e.conditions.call($tt0, c))return t.stopImmediatePropagation(), debug(conf, 'Callback "conditions" returned false.');
                if (!is_number(i)) {
                    if ("*" != opts.items.filter)i = "visible"; else for (var d = [i, e.items, opts[c].items], l = 0, u = d.length; u > l; l++)if (is_number(d[l]) || "page" == d[l] || "visible" == d[l]) {
                        i = d[l];
                        break
                    }
                    switch (i) {
                        case"page":
                            return t.stopImmediatePropagation(), $cfs.triggerHandler(cf_e(c + "Page", conf), [e, o]);
                        case"visible":
                            opts.items.visibleConf.variable || "*" != opts.items.filter || (i = opts.items.visible)
                    }
                }
                if (scrl.isStopped)return $cfs.trigger(cf_e("resume", conf)), $cfs.trigger(cf_e("queue", conf), [c, [e, i, o]]), t.stopImmediatePropagation(), debug(conf, "Carousel resumed scrolling.");
                if (e.duration > 0 && crsl.isScrolling)return e.queue && ("last" == e.queue && (queu = []), ("first" != e.queue || 0 == queu.length) && $cfs.trigger(cf_e("queue", conf), [c, [e, i, o]])), t.stopImmediatePropagation(), debug(conf, "Carousel currently scrolling.");
                if (tmrs.timePassed = 0, $cfs.trigger(cf_e("slide_" + c, conf), [e, i]), opts.synchronise)for (var p = opts.synchronise, f = [e, i], h = 0, u = p.length; u > h; h++) {
                    var m = c;
                ...
                if (sz_resetMargin(o, opts), !is_number(i)) {
                    if (opts.items.visibleConf.variable)i = gn_getVisibleItemsPrev(o, opts, itms.total - 1); else if ("*" != opts.items.filter) {
                        var s = is_number(e.items) ? e.items : gn_getVisibleOrg($cfs, opts);
                        i = gn_getScrollItemsPrevFilter(o, opts, itms.total - 1, s)
                ...
                if (opts.circular || itms.total - i < itms.first && (i = itms.total - itms.first), opts.items.visibleConf.old = opts.items.visible, opts.items.visibleConf.variable) {
                    var n = cf_getItemsAdjust(gn_getVisibleItemsNext(o, opts, itms.total - i), opts, opts.items.visibleConf.adjust, $tt0);
                    opts.items.visible + i <= n && i < itms.total && (i++, n = cf_getItemsAdjust(gn_getVisibleItemsNext(o, opts, itms.total - i), opts, opts.items.visibleConf.adjust, $tt0)), opts.items.visible = n
                } else if ("*" != opts.items.filter) {
                    var n = gn_getVisibleItemsNextFilter(o, opts, itms.total - i);
                    opts.items.visible = cf_getItemsAdjust(n, opts, opts.items.visibleConf.adjust, $tt0)
                }
                if (sz_resetMargin(o, opts, !0), 0 == i)return t.stopImmediatePropagation(), debug(conf, "0 items to scroll: Not scrolling.");
                ...
                var o = $cfs.children(), r = gi_getOldItemsPrev(o, opts, i), a = gi_getNewItemsPrev(o, opts), l = o.eq(i - 1), c = r.last(), d = a.last();
                sz_resetMargin(o, opts);
                var u = 0, p = 0;
                if (opts.align) {
                    var f = cf_getAlignPadding(a, opts);
                    u = f[0], p = f[1]
                }
                var h = 0 > u ? opts.padding[opts.d[3]] : 0, m = !1, g = $();
                if (opts.items.visible < i && (g = o.slice(opts.items.visibleConf.old, i), "directscroll" == e.fx)) {
                    var v = opts.items[opts.d.width];
                    m = g, l = d, sc_hideHiddenItems(m), opts.items[opts.d.width] = "variable"
                }
                var y = !1, b = ms_getTotalSize(o.slice(0, i), opts, "width"), w = cf_mapWrapperSizes(ms_getSizes(a, opts, !0), opts, !opts.usePadding), T = 0, _ = {}, S = {}, P = {}, C = {}, x = {}, k = {}, j = {}, I = sc_getDuration(e, opts, i, b);
                switch (e.fx) {
                    case"cover":
                    case"cover-fade":
                        T = ms_getTotalSize(o.slice(0, opts.items.visible), opts, "width")
                }
                m && (opts.items[opts.d.width] = v), sz_resetMargin(o, opts, !0), p >= 0 && sz_resetMargin(c, opts, opts.padding[opts.d[1]]), u >= 0 && sz_resetMargin(l, opts, opts.padding[opts.d[3]]), opts.align && (opts.padding[opts.d[1]] = p, opts.padding[opts.d[3]] = u), k[opts.d.left] = -(b - h), j[opts.d.left] = -(T - h), S[opts.d.left] = w[opts.d.width];
                var z = function () {
                }, O = function () {
                }, Y = function () {
                }, E = function () {
                ...
                switch (e.fx) {
                    ...
                    case"cover":
                    case"cover-fade":
                        y.children().slice(opts.items.visible).remove(), y.css(j)
                }
                if ($cfs.css(k), scrl = sc_setScroll(I, e.easing, conf), _[opts.d.left] = opts.usePadding ? opts.padding[opts.d[3]] : 0, ("variable" == opts[opts.d.width] || "variable" == opts[opts.d.height]) && (z = function () {
                        $wrp.css(w)
                    }, O = function () {
                        scrl.anims.push([$wrp, w])
                    }), opts.usePadding) {
                    switch (d.not(l).length && (P[opts.d.marginRight] = l.data("_cfs_origCssMargin"), 0 > u ? l.css(P) : (Q = function () {
                        l.css(P)
                    }, L = function () {
                        scrl.anims.push([l, P])
                    })), e.fx) {
                        case"cover":
                        case"cover-fade":
                            y.children().eq(i - 1).css(P)
                    }
                    d.not(c).length && (C[opts.d.marginRight] = c.data("_cfs_origCssMargin"), Y = function () {
                        c.css(C)
                    }, E = function () {
                        scrl.anims.push([c, C])
                    }), p >= 0 && (x[opts.d.marginRight] = d.data("_cfs_origCssMargin") + opts.padding[opts.d[1]], A = function () {
                        d.css(x)
                    }, M = function () {
                        scrl.anims.push([d, x])
                    })
                ...
                R = function () {
                    if (D > 0 && ($cfs.children().slice(itms.total).remove(), r = $($cfs.children().slice(itms.total - (opts.items.visible - D)).get().concat($cfs.children().slice(0, D).get()))), sc_showHiddenItems(m), opts.usePadding) {
                        var t = $cfs.children().eq(opts.items.visible + i - 1);
                        t.css(opts.d.marginRight, t.data("_cfs_origCssMargin"))
                    }
                };
                var W = sc_mapCallbackArguments(r, g, a, i, "prev", I, w);
                switch (N = function () {
                    sc_afterScroll($cfs, y, e), crsl.isScrolling = !1, clbk.onAfter = sc_fireCallbacks($tt0, e, "onAfter", W, clbk), queu = sc_fireQueue($cfs, queu, conf), crsl.isPaused || $cfs.trigger(cf_e("play", conf))
                }, crsl.isScrolling = !0, tmrs = sc_clearTimers(tmrs), clbk.onBefore = sc_fireCallbacks($tt0, e, "onBefore", W, clbk), e.fx) {
                    case"none":
                        $cfs.css(_), z(), Y(), A(), Q(), H(), R(), N();
                        break;
                    case"fade":
                        scrl.anims.push([$cfs, {opacity: 0}, function () {
                            z(), Y(), A(), Q(), H(), R(), scrl = sc_setScroll(I, e.easing, conf), scrl.anims.push([$cfs, {opacity: 1}, N]), sc_startScroll(scrl, conf)
                        }]);
                        break;
                    case"crossfade":
                        $cfs.css({opacity: 0}), scrl.anims.push([y, {opacity: 0}]), scrl.anims.push([$cfs, {opacity: 1}, N]), O(), Y(), A(), Q(), H(), R();
                        break;
                    case"cover":
                        scrl.anims.push([y, _, function () {
                            Y(), A(), Q(), H(), R(), N()
                        }]), O();
                        break;
                    case"cover-fade":
                        scrl.anims.push([$cfs, {opacity: 0}]), scrl.anims.push([y, _, function () {
                            Y(), A(), Q(), H(), R(), N()
                        }]), O();
                        break;
                    case"uncover":
                        scrl.anims.push([y, S, N]), O(), Y(), A(), Q(), H(), R();
                        break;
                    case"uncover-fade":
                        $cfs.css({opacity: 0}), scrl.anims.push([$cfs, {opacity: 1}]), scrl.anims.push([y, S, N]), O(), Y(), A(), Q(), H(), R();
                        break;
                    default:
                ...
                if (sz_resetMargin(o, opts), !is_number(i)) {
                    if ("*" != opts.items.filter) {
                        var s = is_number(e.items) ? e.items : gn_getVisibleOrg($cfs, opts);
                        i = gn_getScrollItemsNextFilter(o, opts, 0, s)
                    } else i = opts.items.visible;
                    i = cf_getAdjust(i, opts, e.items, $tt0)
                }
                var n = 0 == itms.first ? itms.total : itms.first;
                if (!opts.circular) {
                    if (opts.items.visibleConf.variable)var r = gn_getVisibleItemsNext(o, opts, i), s = gn_getVisibleItemsPrev(o, opts, n - 1); else var r = opts.items.visible, s = opts.items.visible;
                    i + r > n && (i = n - s)
                }
                if (opts.items.visibleConf.old = opts.items.visible, opts.items.visibleConf.variable) {
                    for (var r = cf_getItemsAdjust(gn_getVisibleItemsNextTestCircular(o, opts, i, n), opts, opts.items.visibleConf.adjust, $tt0); opts.items.visible - i >= r && i < itms.total;)i++, r = cf_getItemsAdjust(gn_getVisibleItemsNextTestCircular(o, opts, i, n), opts, opts.items.visibleConf.adjust, $tt0);
                    opts.items.visible = r
                } else if ("*" != opts.items.filter) {
                    var r = gn_getVisibleItemsNextFilter(o, opts, i);
                ...
                var o = $cfs.children(), a = gi_getOldItemsNext(o, opts), l = gi_getNewItemsNext(o, opts, i), c = o.eq(i - 1), d = a.last(), u = l.last();
                sz_resetMargin(o, opts);
                var p = 0, f = 0;
                if (opts.align) {
                ...
                var m = !1, g = $();
                if (opts.items.visibleConf.old < i && (g = o.slice(opts.items.visibleConf.old, i), "directscroll" == e.fx)) {
                    var v = opts.items[opts.d.width];
                    m = g, c = d, sc_hideHiddenItems(m), opts.items[opts.d.width] = "variable"
                }
                var y = !1, b = ms_getTotalSize(o.slice(0, i), opts, "width"), w = cf_mapWrapperSizes(ms_getSizes(l, opts, !0), opts, !opts.usePadding), T = 0, _ = {}, S = {}, P = {}, C = {}, x = {}, k = sc_getDuration(e, opts, i, b);
                switch (e.fx) {
                    case"uncover":
                    case"uncover-fade":
                        T = ms_getTotalSize(o.slice(0, opts.items.visibleConf.old), opts, "width")
                }
                m && (opts.items[opts.d.width] = v), opts.align && opts.padding[opts.d[1]] < 0 && (opts.padding[opts.d[1]] = 0), sz_resetMargin(o, opts, !0), sz_resetMargin(d, opts, opts.padding[opts.d[1]]), opts.align && (opts.padding[opts.d[1]] = f, opts.padding[opts.d[3]] = p), x[opts.d.left] = opts.usePadding ? opts.padding[opts.d[3]] : 0;
                var j = function () {
                }, I = function () {
                }, z = function () {
                }, O = function () {
                ...
                if (scrl = sc_setScroll(k, e.easing, conf), _[opts.d.left] = -b, S[opts.d.left] = -T, 0 > p && (_[opts.d.left] += p), ("variable" == opts[opts.d.width] || "variable" == opts[opts.d.height]) && (j = function () {
                        $wrp.css(w)
                    }, I = function () {
                        scrl.anims.push([$wrp, w])
                    }), opts.usePadding) {
                    var L = u.data("_cfs_origCssMargin");
                    f >= 0 && (L += opts.padding[opts.d[1]]), u.css(opts.d.marginRight, L), c.not(d).length && (C[opts.d.marginRight] = d.data("_cfs_origCssMargin")), z = function () {
                        d.css(C)
                    }, O = function () {
                        scrl.anims.push([d, C])
                    };
                    var N = c.data("_cfs_origCssMargin");
                    p > 0 && (N += opts.padding[opts.d[3]]), P[opts.d.marginRight] = N, Y = function () {
                        c.css(P)
                    }, E = function () {
                        scrl.anims.push([c, P])
                    }
                ...
                M = function () {
                    ...
                    if (R > 0 && (l = gi_getCurrentItems(o, opts)), sc_showHiddenItems(m), opts.usePadding) {
                ...
                var H = sc_mapCallbackArguments(a, g, l, i, "next", k, w);
                switch (A = function () {
                    $cfs.css("zIndex", $cfs.data("_cfs_origCssZindex")), sc_afterScroll($cfs, y, e), crsl.isScrolling = !1, clbk.onAfter = sc_fireCallbacks($tt0, e, "onAfter", H, clbk), queu = sc_fireQueue($cfs, queu, conf), crsl.isPaused || $cfs.trigger(cf_e("play", conf))
                }, crsl.isScrolling = !0, tmrs = sc_clearTimers(tmrs), clbk.onBefore = sc_fireCallbacks($tt0, e, "onBefore", H, clbk), e.fx) {
                    case"none":
                        $cfs.css(_), j(), z(), Y(), Q(), M(), A();
                        break;
                    case"fade":
                        scrl.anims.push([$cfs, {opacity: 0}, function () {
                            j(), z(), Y(), Q(), M(), scrl = sc_setScroll(k, e.easing, conf), scrl.anims.push([$cfs, {opacity: 1}, A]), sc_startScroll(scrl, conf)
                        }]);
                        break;
                    case"crossfade":
                        $cfs.css({opacity: 0}), scrl.anims.push([y, {opacity: 0}]), scrl.anims.push([$cfs, {opacity: 1}, A]), I(), z(), Y(), Q(), M();
                        break;
                    case"cover":
                        $cfs.css(opts.d.left, $wrp[opts.d.width]()), scrl.anims.push([$cfs, x, A]), I(), z(), Y(), M();
                        break;
                    case"cover-fade":
                        $cfs.css(opts.d.left, $wrp[opts.d.width]()), scrl.anims.push([y, {opacity: 0}]), scrl.anims.push([$cfs, x, A]), I(), z(), Y(), M();
                        break;
                    case"uncover":
                        scrl.anims.push([y, S, A]), I(), z(), Y(), Q(), M();
                        break;
                    case"uncover-fade":
                        $cfs.css({opacity: 0}), scrl.anims.push([$cfs, {opacity: 1}]), scrl.anims.push([y, S, A]), I(), z(), Y(), Q(), M();
                        break;
                    default:
                        scrl.anims.push([$cfs, _, function () {
                            Q(), M(), A()
                ...
                return sc_startScroll(scrl, conf), cf_setCookie(opts.cookie, $cfs, conf), $cfs.trigger(cf_e("updatePageStatus", conf), [!1, w]), !0
            }), $cfs.bind(cf_e("slideTo", conf), function (t, e, i, o, s, n, r) {
                t.stopPropagation();
                var a = [e, i, o, s, n, r], l = ["string/number/object", "number", "boolean", "object", "string", "function"], c = cf_sortParams(a, l);
                return s = c[3], n = c[4], r = c[5], e = gn_getItemIndex(c[0], c[1], c[2], itms, $cfs), 0 == e ? !1 : (is_object(s) || (s = !1), "prev" != n && "next" != n && (n = opts.circular ? e <= itms.total / 2 ? "next" : "prev" : 0 == itms.first || itms.first > e ? "next" : "prev"), "prev" == n && (e = itms.total - e), $cfs.trigger(cf_e(n, conf), [s, e, r]), !0)
            }), $cfs.bind(cf_e("prevPage", conf), function (t, e, i) {
                t.stopPropagation();
                var o = $cfs.triggerHandler(cf_e("currentPage", conf));
                return $cfs.triggerHandler(cf_e("slideToPage", conf), [o - 1, e, "prev", i])
            }), $cfs.bind(cf_e("nextPage", conf), function (t, e, i) {
                t.stopPropagation();
                var o = $cfs.triggerHandler(cf_e("currentPage", conf));
                return $cfs.triggerHandler(cf_e("slideToPage", conf), [o + 1, e, "next", i])
            }), $cfs.bind(cf_e("slideToPage", conf), function (t, e, i, o, s) {
                ...
                return 0 > e && (e = r), e > r && (e = 0), $cfs.triggerHandler(cf_e("slideTo", conf), [e * n, 0, !0, i, o, s])
                ...
                for (var i = $cfs.triggerHandler(cf_e("currentPosition", conf)), o = !0, s = 0, n = e.length; n > s; s++)e[s][0].triggerHandler(cf_e("slideTo", conf), [i, e[s][3], !0]) || (o = !1);
                return o
            ...
            }), $cfs.bind(cf_e("insertItem", conf), function (t, e, i, o, s) {
                t.stopPropagation();
                var n = [e, i, o, s], r = ["string/object", "string/number/object", "boolean", "number"], a = cf_sortParams(n, r);
                if (e = a[0], i = a[1], o = a[2], s = a[3], is_object(e) && !is_jquery(e) ? e = $(e) : is_string(e) && (e = $(e)), !is_jquery(e) || 0 == e.length)return debug(conf, "Not a valid object.");
                is_undefined(i) && (i = "end"), sz_storeMargin(e, opts), sz_storeOrigCss(e);
                var l = i, c = "before";
                "end" == i ? o ? (0 == itms.first ? (i = itms.total - 1, c = "after") : (i = itms.first, itms.first += e.length), 0 > i && (i = 0)) : (i = itms.total - 1, c = "after") : i = gn_getItemIndex(i, s, o, itms, $cfs);
                var d = $cfs.children().eq(i);
                return d.length ? d[c](e) : (debug(conf, "Correct insert-position not found! Appending item to the end."), $cfs.append(e)), "end" == l || o || i < itms.first && (itms.first += e.length), itms.total = $cfs.children().length, itms.first >= itms.total && (itms.first -= itms.total), $cfs.trigger(cf_e("updateSizes", conf)), $cfs.trigger(cf_e("linkAnchors", conf)), !0
            }), $cfs.bind(cf_e("removeItem", conf), function (t, e, i, o) {
                t.stopPropagation();
                var s = [e, i, o], n = ["string/number/object", "boolean", "number"], r = cf_sortParams(s, n);
                if (e = r[0], i = r[1], o = r[2], e instanceof $ && e.length > 1)return a = $(), e.each(function (t, e) {
                    var s = $cfs.trigger(cf_e("removeItem", conf), [$(this), i, o]);
                    s && (a = a.add(s))
                }), a;
                if (is_undefined(e) || "end" == e)a = $cfs.children().last(); else {
                    e = gn_getItemIndex(e, o, i, itms, $cfs);
                ...
                t.stopPropagation();
                var i, o = opts.pagination.items || opts.items.visible, s = Math.ceil(itms.total / o - 1);
                return i = 0 == itms.first ? 0 : itms.first < itms.total % o ? 0 : itms.first != o || opts.circular ? Math.round((itms.total - itms.first) / o) : s, 0 > i && (i = 0), i > s && (i = s), is_function(e) && e.call($tt0, i), i
            }), $cfs.bind(cf_e("currentVisible", conf), function (t, e) {
                t.stopPropagation();
                var i = gi_getCurrentItems($cfs.children(), opts);
                return is_function(e) && e.call($tt0, i), i
            }), $cfs.bind(cf_e("slice", conf), function (t, e, i, o) {
                if (t.stopPropagation(), 0 == itms.total)return !1;
                var s = [e, i, o], n = ["number", "number", "function"], r = cf_sortParams(s, n);
                if (e = is_number(r[0]) ? r[0] : 0, i = is_number(r[1]) ? r[1] : itms.total, o = r[2], e += itms.first, i += itms.first, items.total > 0) {
                ...
                return a = i > e ? l.slice(e, i) : $(l.slice(e, itms.total).get().concat(l.slice(0, i).get())), is_function(o) && o.call($tt0, a), a
            }), $cfs.bind(cf_e("isPaused", conf) + " " + cf_e("isStopped", conf) + " " + cf_e("isScrolling", conf), function (t, e) {
                t.stopPropagation();
                var i = t.type.slice(conf.events.prefix.length), o = crsl[i];
                return is_function(e) && e.call($tt0, o), o
                ...
                if (t.stopPropagation(), opts.pagination.container) {
                    var o = opts.pagination.items || opts.items.visible, s = Math.ceil(itms.total / o);
                    e && (opts.pagination.anchorBuilder && (opts.pagination.container.children().remove(), opts.pagination.container.each(function () {
                        for (var t = 0; s > t; t++) {
                            var e = $cfs.children().eq(gn_getItemIndex(t * o, 0, !0, itms, $cfs));
                        ...
                        $(this).children().unbind(opts.pagination.event).each(function (t) {
                            $(this).bind(opts.pagination.event, function (e) {
                                e.preventDefault(), $cfs.trigger(cf_e("slideTo", conf), [t * o, -opts.pagination.deviation, !0, opts.pagination])
                            })
                        })
                    }));
                ...
                var e = opts.items.visible, i = $cfs.children(), o = ms_getParentSize($wrp, opts, "width");
            ...
            if ((opts.prev.key || opts.next.key) && $(document).bind(cf_e("keyup", conf, !1, !0, !0), function (t) {
                ...
                if (e && opts.swipe.onTouch || !e && opts.swipe.onMouse) {
                    var i = $.extend(!0, {}, opts.prev, opts.swipe), o = $.extend(!0, {}, opts.next, opts.swipe), s = function () {
                        $cfs.trigger(cf_e("prev", conf), [i])
                    }, n = function () {
                        $cfs.trigger(cf_e("next", conf), [o])
                    };
                    switch (opts.direction) {
                        case"up":
                        case"down":
                            opts.swipe.options.swipeUp = n, opts.swipe.options.swipeDown = s;
                            break;
                        default:
                            opts.swipe.options.swipeLeft = n, opts.swipe.options.swipeRight = s
                    }
        ...
        get: function (t) {
            t += "=";
            for (var e = document.cookie.split(";"), i = 0, o = e.length; o > i; i++) {
    ...
    t.getElementById(i) || (o = t.createElement(e), o.id = i,
        o.src = "", s.parentNode.insertBefore(o, s))
